  ...
  extends CrashlyticsReport.Session.Event.Device
{
  ...
  private AutoValue_CrashlyticsReport_Session_Event_Device(@Nullable Double paramDouble, int paramInt1, boolean paramBoolean, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      CrashlyticsReport.Session.Event.Device localDevice = (CrashlyticsReport.Session.Event.Device)paramObject;
      paramObject = this.batteryLevel;
      if ((paramObject == null ? localDevice.getBatteryLevel() != null : !((Double)paramObject).equals(localDevice.getBatteryLevel())) || (this.batteryVelocity != localDevice.getBatteryVelocity()) || (this.proximityOn != localDevice.isProximityOn()) || (this.orientation != localDevice.getOrientation()) || (this.ramUsed != localDevice.getRamUsed()) || (this.diskUsed != localDevice.getDiskUsed())) {
        bool = false;
      }
      return bool;
    }
    ...
    extends CrashlyticsReport.Session.Event.Device.Builder
  {
    ...
    {
      Object localObject1 = this.batteryVelocity;
      Object localObject2 = "";
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\firebase\crashlytics\internal\model\AutoValue_CrashlyticsReport_Session_Event_Device.class
