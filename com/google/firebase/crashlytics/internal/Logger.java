...
public class Logger
{
  ...
  {
    boolean bool;
    if ((this.logLevel > paramInt) && (!Log.isLoggable(this.tag, paramInt))) {
      bool = false;
    } else {
      bool = true;
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\firebase\crashlytics\internal\Logger.class
