  ...
  implements SettingsJsonTransform
{
    ...
    throws JSONException
  {
    ...
    return new AppSettingsData(str1, paramJSONObject1, String.format(localLocale, "https://reports.crashlytics.com/spi/v1/platforms/android/apps/%s/reports", new Object[] { str2 }), String.format(localLocale, "https://reports.crashlytics.com/sdk-api/v1/platforms/android/apps/%s/minidumps", new Object[] { str2 }), str2, str3, paramJSONObject2.optBoolean("update_required", false), paramJSONObject2.optInt("report_upload_variant", 0), paramJSONObject2.optInt("native_report_upload_variant", 0));
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\firebase\crashlytics\internal\settings\SettingsV3JsonTransform.class
