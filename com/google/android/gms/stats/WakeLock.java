...
public class WakeLock
{
  ...
  private WakeLock(@NonNull Context paramContext, int paramInt, @NonNull String paramString1, @Nullable String paramString2, @NonNull String paramString3, @Nullable String paramString4)
  {
    ...
    this.zzf = null;
    this.zzg = null;
    paramString4 = paramContext.getApplicationContext();
    ...
    paramString2 = ((PowerManager)paramContext.getSystemService("power")).newWakeLock(paramInt, paramString1);
    ...
    if (WorkSourceUtil.hasWorkSourcePermission(paramContext))
    {
      ...
      if ((paramContext != null) && (WorkSourceUtil.hasWorkSourcePermission(paramString4)))
      {
        ...
        try
        {
          paramString2.setWorkSource(paramContext);
        }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\stats\WakeLock.class
