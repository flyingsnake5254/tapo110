...
public final class Objects
{
  ...
  public static final class ToStringHelper
  {
    ...
    public final ToStringHelper add(String paramString, @Nullable Object paramObject)
    {
      ...
      StringBuilder localStringBuilder = new StringBuilder(String.valueOf(paramString).length() + 1 + ((String)paramObject).length());
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\common\internal\Objects.class
