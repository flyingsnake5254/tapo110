...
public final class Asserts
{
  ...
  public static void checkMainThread(String paramString)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(str1.length() + 57 + str2.length());
  ...
  public static void checkNotMainThread(String paramString)
  {
    ...
    String str1 = String.valueOf(Thread.currentThread());
    String str2 = String.valueOf(Looper.getMainLooper().getThread());
    StringBuilder localStringBuilder = new StringBuilder(str1.length() + 56 + str2.length());
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\common\internal\Asserts.class
