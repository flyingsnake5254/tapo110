  ...
  implements zabd
{
  ...
  private final void zaa(zaj paramzaj)
  {
    ...
    if (((ConnectionResult)localObject).isSuccess())
    {
      ...
      if (!paramzaj.isSuccess())
      {
        ...
        Log.wtf("GoogleApiClientConnecting", ((StringBuilder)localObject).toString(), new Exception());
        zae(paramzaj);
        return;
      }
      this.zage = true;
  ...
  {
    ArrayList localArrayList = this.zagi;
  ...
  {
    int i = paramApi.zah().getPriority();
    int j = 0;
    int m;
    if (paramBoolean)
    {
  ...
  private final boolean zac(int paramInt)
  {
    if (this.zafx != paramInt)
    {
      ...
      String str = zad(this.zafx);
      localObject2 = zad(paramInt);
      localObject1 = new StringBuilder(String.valueOf(str).length() + 70 + String.valueOf(localObject2).length());
      ((StringBuilder)localObject1).append("GoogleApiClient connecting is in step ");
      ((StringBuilder)localObject1).append(str);
      ((StringBuilder)localObject1).append(" but received callback for step ");
      ((StringBuilder)localObject1).append((String)localObject2);
      Log.wtf("GoogleApiClientConnecting", ((StringBuilder)localObject1).toString(), new Exception());
      zae(new ConnectionResult(8, null));
      return false;
    }
    return true;
  ...
  public final void begin()
  {
    ...
    if (this.zagd)
    {
      ...
      Api.AbstractClientBuilder localAbstractClientBuilder = this.zace;
      localObject1 = this.mContext;
      localObject3 = this.zaft.zaee.getLooper();
      localObject2 = this.zaet;
      this.zagb = ((zad)localAbstractClientBuilder.buildClient((Context)localObject1, (Looper)localObject3, (ClientSettings)localObject2, ((ClientSettings)localObject2).getSignInOptions(), localzaat, localzaat));
    }
    this.zafy = this.zaft.zagz.size();
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\common\api\internal\zaak.class
