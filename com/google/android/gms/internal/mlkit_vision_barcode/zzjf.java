  ...
  extends zzja
{
  private static int zza(byte[] paramArrayOfByte, int paramInt1, long paramLong, int paramInt2)
  {
    if (paramInt2 != 0)
    {
      ...
      {
        if (paramInt2 == 2) {
          return zzjb.zza(paramInt1, zziz.zza(paramArrayOfByte, paramLong), zziz.zza(paramArrayOfByte, paramLong + 1L));
        }
        throw new AssertionError();
      }
      return zzjb.zza(paramInt1, zziz.zza(paramArrayOfByte, paramLong));
    }
    return zzjb.zza(paramInt1);
  }
  ...
  final int zza(int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    if ((paramInt2 | paramInt3 | paramArrayOfByte.length - paramInt3) >= 0)
    {
      ...
      else
      {
        ...
        {
          if (zziz.zza(paramArrayOfByte, l2) < 0) {
            break label73;
          }
          paramInt1++;
          l2 += 1L;
      ...
      for (;;)
      {
        ...
        l1 = l2 + 1L;
        paramInt1 = zziz.zza(paramArrayOfByte, l2);
        if (paramInt1 < 0) {
          break;
        }
        paramInt2--;
      ...
      if (paramInt1 < -32)
      {
        ...
        if (paramInt1 >= -62)
        {
          l2 = l1 + 1L;
          paramInt1 = paramInt2;
          if (zziz.zza(paramArrayOfByte, l1) > -65) {}
        }
      }
      do
      {
        ...
        if (paramInt1 < -16)
        {
          ...
          paramInt2 -= 2;
          long l3 = l1 + 1L;
          paramInt3 = zziz.zza(paramArrayOfByte, l1);
          if ((paramInt3 <= -65) && ((paramInt1 != -32) || (paramInt3 >= -96)) && ((paramInt1 != -19) || (paramInt3 < -96)))
          {
            l2 = l3 + 1L;
            paramInt1 = paramInt2;
            if (zziz.zza(paramArrayOfByte, l3) <= -65) {
              break;
            }
          }
          return -1;
        ...
        l1 = l2 + 1L;
        if (zziz.zza(paramArrayOfByte, l2) > -65) {
          break label367;
        }
        l2 = l1 + 1L;
        paramInt1 = paramInt2;
      } while (zziz.zza(paramArrayOfByte, l1) <= -65);
      label367:
      return -1;
    }
  ...
  final int zza(CharSequence paramCharSequence, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    if ((i <= paramInt2) && (paramArrayOfByte.length - paramInt2 >= paramInt1))
    {
      ...
      for (;;)
      {
        ...
        zziz.zza(paramArrayOfByte, l1, (byte)paramInt1);
        paramInt2++;
        l1 = 1L + l1;
      }
      paramInt1 = paramInt2;
      ...
      while (paramInt1 < i)
      {
        ...
        if ((j < 128) && (l4 < l2))
        {
          zziz.zza(paramArrayOfByte, l4, (byte)j);
          long l5 = l3;
          l1 = l4 + l3;
          l3 = l5;
        }
        for (;;)
        {
          ...
          {
            l1 = l4 + l3;
            zziz.zza(paramArrayOfByte, l4, (byte)(j >>> 6 | 0x3C0));
            zziz.zza(paramArrayOfByte, l1, (byte)(j & 0x3F | 0x80));
            l1 += l3;
          }
          else if (((j < 55296) || (57343 < j)) && (l4 <= l2 - 3L))
          {
            l1 = l4 + l3;
            zziz.zza(paramArrayOfByte, l4, (byte)(j >>> 12 | 0x1E0));
            l3 = l1 + l3;
            zziz.zza(paramArrayOfByte, l1, (byte)(j >>> 6 & 0x3F | 0x80));
            zziz.zza(paramArrayOfByte, l3, (byte)(j & 0x3F | 0x80));
            l1 = l3 + 1L;
            l3 = 1L;
          }
          else
          {
            ...
            l3 = l4 + 1L;
            zziz.zza(paramArrayOfByte, l4, (byte)(paramInt1 >>> 18 | 0xF0));
            l1 = l3 + 1L;
            zziz.zza(paramArrayOfByte, l3, (byte)(paramInt1 >>> 12 & 0x3F | 0x80));
            l4 = l1 + 1L;
            zziz.zza(paramArrayOfByte, l1, (byte)(paramInt1 >>> 6 & 0x3F | 0x80));
            l3 = 1L;
            l1 = l4 + 1L;
            zziz.zza(paramArrayOfByte, l4, (byte)(paramInt1 & 0x3F | 0x80));
            paramInt1 = paramInt2;
          }
        }
        paramInt1++;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\internal\mlkit_vision_barcode\zzjf.class
