      ...
      if (i < 0) {
        ...
        else if (i < -16)
        {
          if (paramInt2 >= paramInt3 - 1) {
            return zzjb.zzb(paramArrayOfByte, paramInt2, paramInt3);
          }
          int j = paramInt2 + 1;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\internal\mlkit_vision_barcode\zzjd.class
