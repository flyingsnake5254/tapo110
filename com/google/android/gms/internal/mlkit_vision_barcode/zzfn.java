  ...
  extends zzex
{
  ...
  public static int zza(int paramInt, zzgt paramzzgt)
  {
  ...
  public static int zza(zzgt paramzzgt)
  {
    int i = paramzzgt.zzb();
    return zzg(i) + i;
  }
  
  static int zza(zzhk paramzzhk, zzib paramzzib)
  {
    paramzzhk = (zzer)paramzzhk;
    int i = paramzzhk.zzg();
    int j = i;
    if (i == -1)
    {
      j = paramzzib.zzb(paramzzhk);
      paramzzhk.zza(j);
    }
    return zzg(j) + j;
  }
  
  public static zzfn zza(byte[] paramArrayOfByte)
  {
  ...
  public static int zzb(int paramInt, zzgt paramzzgt)
  {
    return (zze(1) << 1) + zzg(2, paramInt) + zza(3, paramzzgt);
  }
  
  public static int zzb(int paramInt, zzhk paramzzhk)
  {
    return (zze(1) << 1) + zzg(2, paramInt) + (zze(3) + zzb(paramzzhk));
  }
  
  static int zzb(int paramInt, zzhk paramzzhk, zzib paramzzib)
  {
    return zze(paramInt) + zza(paramzzhk, paramzzib);
  }
  ...
  public static int zzb(zzew paramzzew)
  {
    int i = paramzzew.zza();
    return zzg(i) + i;
  }
  
  public static int zzb(zzhk paramzzhk)
  {
    int i = paramzzhk.zzj();
    return zzg(i) + i;
  }
  ...
  public static int zzb(String paramString)
  {
    ...
    try
    {
      i = zzjb.zza(paramString);
    }
    catch (zzjc localzzjc)
    {
      i = paramString.getBytes(zzgc.zza).length;
    }
    return zzg(i) + i;
  }
  ...
  public static int zzc(int paramInt, zzew paramzzew)
  {
    int i = zze(paramInt);
    paramInt = paramzzew.zza();
    return i + (zzg(paramInt) + paramInt);
  }
  
  @Deprecated
  static int zzc(int paramInt, zzhk paramzzhk, zzib paramzzib)
  {
    int i = zze(paramInt);
    paramzzhk = (zzer)paramzzhk;
    int j = paramzzhk.zzg();
    ...
    if (j == -1)
    {
      paramInt = paramzzib.zzb(paramzzhk);
      paramzzhk.zza(paramInt);
    }
    return (i << 1) + paramInt;
  }
  
  @Deprecated
  public static int zzc(zzhk paramzzhk)
  {
    return paramzzhk.zzj();
  }
  ...
  public static int zzd(int paramInt, zzew paramzzew)
  {
    return (zze(1) << 1) + zzg(2, paramInt) + zzc(3, paramzzew);
  }
  ...
  public abstract void zza(int paramInt, zzew paramzzew)
    throws IOException;
  
  public abstract void zza(int paramInt, zzhk paramzzhk)
    throws IOException;
  
  abstract void zza(int paramInt, zzhk paramzzhk, zzib paramzzib)
    throws IOException;
  ...
  public abstract void zza(zzew paramzzew)
    throws IOException;
  ...
  final void zza(String paramString, zzjc paramzzjc)
    throws IOException
  {
    zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", paramzzjc);
    paramString = paramString.getBytes(zzgc.zza);
    try
    {
  ...
  public abstract void zzb(int paramInt, zzew paramzzew)
    throws IOException;
    ...
    extends zzfn
  {
      ...
      throws IOException
    {
      ...
      {
        throw new zzfn.zza(String.format("Pos: %d, limit: %d, len: %d", new Object[] { Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(paramInt2) }), paramArrayOfByte);
      }
    }
      ...
      throws IOException
    {
      ...
      {
        throw new zzfn.zza(String.format("Pos: %d, limit: %d, len: %d", new Object[] { Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(1) }), localIndexOutOfBoundsException);
      }
    }
    ...
    public final void zza(int paramInt, zzhk paramzzhk)
      throws IOException
    {
      zza(1, 3);
      zzc(2, paramInt);
    ...
    final void zza(int paramInt, zzhk paramzzhk, zzib paramzzib)
      throws IOException
    {
      zza(paramInt, 2);
      zzer localzzer = (zzer)paramzzhk;
      int i = localzzer.zzg();
      paramInt = i;
      if (i == -1)
      {
        paramInt = paramzzib.zzb(localzzer);
        localzzer.zza(paramInt);
      }
      zzb(paramInt);
      paramzzib.zza(paramzzhk, this.zza);
    }
        ...
        if (zza() >= 10) {
          for (;;)
          {
            if ((paramLong & 0xFFFFFFFFFFFFFF80) == 0L)
            {
              ...
              i = this.zze;
              this.zze = (i + 1);
              zziz.zza(arrayOfByte, i, (byte)(int)paramLong);
              return;
            }
            arrayOfByte = this.zzb;
            i = this.zze;
            this.zze = (i + 1);
            zziz.zza(arrayOfByte, i, (byte)((int)paramLong & 0x7F | 0x80));
            paramLong >>>= 7;
          }
        }
      }
    ...
    public final void zza(zzhk paramzzhk)
      throws IOException
    {
      zzb(paramzzhk.zzj());
      paramzzhk.zza(this);
      ...
      throws IOException
    {
      ...
      try
      {
        int j = zzfn.zzg(paramString.length() * 3);
        int k = zzfn.zzg(paramString.length());
        if (k == j)
        {
          j = i + k;
          this.zze = j;
          j = zzjb.zza(paramString, this.zzb, j, zza());
          this.zze = i;
          zzb(j - i - k);
          this.zze = j;
          return;
        }
        zzb(zzjb.zza(paramString));
        this.zze = zzjb.zza(paramString, this.zzb, this.zze, zza());
        return;
      }
      catch (IndexOutOfBoundsException paramString)
      {
        throw new zzfn.zza(paramString);
      }
      catch (zzjc localzzjc)
      {
        this.zze = i;
        zza(paramString, localzzjc);
      }
    }
        ...
        if (!zzeu.zza())
        {
          ...
          if (zza() >= 5)
          {
            if ((paramInt & 0xFFFFFF80) == 0)
            {
              ...
              i = this.zze;
              this.zze = (i + 1);
              zziz.zza(arrayOfByte, i, (byte)paramInt);
              return;
            }
            arrayOfByte = this.zzb;
            i = this.zze;
            this.zze = (i + 1);
            zziz.zza(arrayOfByte, i, (byte)(paramInt | 0x80));
            paramInt >>>= 7;
            if ((paramInt & 0xFFFFFF80) == 0)
            {
              arrayOfByte = this.zzb;
            ...
            i = this.zze;
            this.zze = (i + 1);
            zziz.zza(arrayOfByte, i, (byte)(paramInt >>> 7));
            return;
          }
        }
      }
    ...
    public final void zzb(int paramInt, zzew paramzzew)
      throws IOException
    {
      zza(1, 3);
      zzc(2, paramInt);
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\internal\mlkit_vision_barcode\zzfn.class
