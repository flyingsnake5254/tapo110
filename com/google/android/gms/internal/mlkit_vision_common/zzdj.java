  ...
  implements Serializable, Iterable<Byte>
{
  ...
  private static final Comparator<zzdj> zzd = new zzdl();
  private int zzc = 0;
  ...
  static
  {
    Object localObject;
    if (zzdh.zza()) {
      localObject = new zzds(null);
    } else {
      localObject = new zzdn(null);
    }
    zzb = (zzdp)localObject;
  }
  
  public static zzdj zza(String paramString)
  {
    return new zzdt(paramString.getBytes(zzem.zza));
  }
  ...
  static zzdr zzc(int paramInt)
  {
    return new zzdr(paramInt, null);
  }
  ...
  public final String toString()
  {
    ...
    if (zza() <= 50) {
      ...
      str2 = String.valueOf(zzgw.zza(zza(0, 47))).concat("...");
    }
  ...
  public abstract zzdj zza(int paramInt1, int paramInt2);
  
  protected abstract String zza(Charset paramCharset);
  
  abstract void zza(zzdg paramzzdg)
    throws IOException;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\internal\mlkit_vision_common\zzdj.class
