...
final class zzhg
{
  ...
  static
  {
    ...
    if ((localObject1 != null) && (localObject2 != null)) {
      l2 = ((zzd)localObject2).zza.objectFieldOffset((Field)localObject1);
    } else {
      l2 = -1L;
    }
    zzw = l2;
  ...
  {
    // Byte code:
    //   0: new 252	com/google/android/gms/internal/mlkit_vision_common/zzhi
    //   3: astore_0
    //   4: aload_0
    //   5: invokespecial 253	com/google/android/gms/internal/mlkit_vision_common/zzhi:<init>	()V
    //   8: aload_0
    ...
    extends zzhg.zzd
  {
    ...
    {
      if (zzhg.zza) {
        return zzhg.zzg(paramObject, paramLong);
      }
      return zzhg.zzh(paramObject, paramLong);
    }
    ...
    public final void zza(Object paramObject, long paramLong, byte paramByte)
    {
      if (zzhg.zza)
      {
        zzhg.zza(paramObject, paramLong, paramByte);
        return;
      }
      zzhg.zzb(paramObject, paramLong, paramByte);
    }
    ...
    public final void zza(Object paramObject, long paramLong, boolean paramBoolean)
    {
      if (zzhg.zza)
      {
        zzhg.zzb(paramObject, paramLong, paramBoolean);
        return;
      }
      zzhg.zzc(paramObject, paramLong, paramBoolean);
    }
    
    public final boolean zzb(Object paramObject, long paramLong)
    {
      if (zzhg.zza) {
        return zzhg.zzi(paramObject, paramLong);
      }
      return zzhg.zzj(paramObject, paramLong);
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\gms\internal\mlkit_vision_common\zzhg.class
