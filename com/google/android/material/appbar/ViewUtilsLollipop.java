...
class ViewUtilsLollipop
{
  ...
  static void setBoundsViewOutlineProvider(@NonNull View paramView)
  {
    paramView.setOutlineProvider(ViewOutlineProvider.BOUNDS);
  }
  
  static void setDefaultAppBarLayoutStateListAnimator(@NonNull View paramView, float paramFloat)
  {
  ...
  static void setStateListAnimatorFromAttrs(@NonNull View paramView, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\material\appbar\ViewUtilsLollipop.class
