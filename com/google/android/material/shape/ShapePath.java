...
public class ShapePath
{
  ...
  public void addArc(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    ...
    addShadowCompatOperation((ShadowCompatOperation)localObject, paramFloat6, paramFloat5);
    paramFloat5 = (paramFloat3 - paramFloat1) / 2.0F;
    double d = f;
    setEndX((paramFloat1 + paramFloat3) * 0.5F + paramFloat5 * (float)Math.cos(Math.toRadians(d)));
    setEndY((paramFloat2 + paramFloat4) * 0.5F + (paramFloat4 - paramFloat2) / 2.0F * (float)Math.sin(Math.toRadians(d)));
  }
  ...
  public void applyToPath(Matrix paramMatrix, Path paramPath)
  {
    ...
    for (int j = 0; j < i; j++) {
      ((PathOperation)this.operations.get(j)).applyToPath(paramMatrix, paramPath);
    }
  }
    ...
    extends ShapePath.ShadowCompatOperation
  {
    ...
    public void draw(Matrix paramMatrix, @NonNull ShadowRenderer paramShadowRenderer, int paramInt, @NonNull Canvas paramCanvas)
    {
    ...
    extends ShapePath.ShadowCompatOperation
  {
    ...
    public void draw(Matrix paramMatrix, @NonNull ShadowRenderer paramShadowRenderer, int paramInt, @NonNull Canvas paramCanvas)
    {
      float f1 = ShapePath.PathLineOperation.access$100(this.operation);
      float f2 = this.startY;
      float f3 = ShapePath.PathLineOperation.access$000(this.operation);
    ...
    extends ShapePath.PathOperation
  {
    ...
    public void applyToPath(@NonNull Matrix paramMatrix, @NonNull Path paramPath)
    {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\material\shape\ShapePath.class
