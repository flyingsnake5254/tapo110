  ...
  extends ExpandableTransformationBehavior
{
  ...
  @Nullable
  private ViewGroup calculateChildContentContainer(@NonNull View paramView)
  {
  ...
  private void calculateChildVisibleBoundsAtEndOfExpansion(@NonNull View paramView, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull MotionTiming paramMotionTiming1, @NonNull MotionTiming paramMotionTiming2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, @NonNull RectF paramRectF)
  {
  ...
  private void calculateDependencyWindowBounds(@NonNull View paramView, @NonNull RectF paramRectF)
  {
  ...
  @NonNull
  private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float paramFloat1, float paramFloat2, boolean paramBoolean, @NonNull FabTransformationSpec paramFabTransformationSpec)
  {
    if (paramFloat1 != 0.0F)
    {
      ...
      if (bool)
      {
        ...
        localObject = paramFabTransformationSpec.timings.getTiming("translationXCurveDownwards");
        localMotionTiming = paramFabTransformationSpec.timings.getTiming("translationYCurveDownwards");
        paramFabTransformationSpec = (FabTransformationSpec)localObject;
        localObject = localMotionTiming;
        break label136;
      }
    }
    MotionTiming localMotionTiming = paramFabTransformationSpec.timings.getTiming("translationXLinear");
    Object localObject = paramFabTransformationSpec.timings.getTiming("translationYLinear");
    paramFabTransformationSpec = localMotionTiming;
    label136:
    return new Pair(paramFabTransformationSpec, localObject);
  }
  
  private float calculateRevealCenterX(@NonNull View paramView1, @NonNull View paramView2, @NonNull Positioning paramPositioning)
  {
  ...
  private float calculateRevealCenterY(@NonNull View paramView1, @NonNull View paramView2, @NonNull Positioning paramPositioning)
  {
    RectF localRectF1 = this.tmpRectF1;
    RectF localRectF2 = this.tmpRectF2;
    calculateDependencyWindowBounds(paramView1, localRectF1);
  ...
  private float calculateTranslationX(@NonNull View paramView1, @NonNull View paramView2, @NonNull Positioning paramPositioning)
  {
    RectF localRectF1 = this.tmpRectF1;
    RectF localRectF2 = this.tmpRectF2;
    calculateDependencyWindowBounds(paramView1, localRectF1);
  ...
  private float calculateTranslationY(@NonNull View paramView1, @NonNull View paramView2, @NonNull Positioning paramPositioning)
  {
    RectF localRectF1 = this.tmpRectF1;
    RectF localRectF2 = this.tmpRectF2;
    calculateDependencyWindowBounds(paramView1, localRectF1);
  ...
  private float calculateValueOfAnimationAtEndOfExpansion(@NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull MotionTiming paramMotionTiming, float paramFloat1, float paramFloat2)
  {
  ...
  private void calculateWindowBounds(@NonNull View paramView, RectF paramRectF)
  {
  ...
  private void createChildrenFadeAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull List<Animator> paramList, List<Animator.AnimatorListener> paramList1)
  {
  ...
  private void createColorAnimation(@NonNull View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull List<Animator> paramList, List<Animator.AnimatorListener> paramList1)
  {
  ...
  private void createDependencyTranslationAnimation(@NonNull View paramView1, @NonNull View paramView2, boolean paramBoolean, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull List<Animator> paramList)
  {
  ...
  @TargetApi(21)
  private void createElevationAnimation(View paramView1, @NonNull View paramView2, boolean paramBoolean1, boolean paramBoolean2, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull List<Animator> paramList, List<Animator.AnimatorListener> paramList1)
  {
  ...
  private void createExpansionAnimation(@NonNull View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, @NonNull FabTransformationSpec paramFabTransformationSpec, float paramFloat1, float paramFloat2, @NonNull List<Animator> paramList, @NonNull List<Animator.AnimatorListener> paramList1)
  {
    if (!(paramView2 instanceof CircularRevealWidget)) {
      return;
    }
  ...
  private void createIconFadeAnimation(View paramView1, final View paramView2, boolean paramBoolean1, boolean paramBoolean2, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull List<Animator> paramList, @NonNull List<Animator.AnimatorListener> paramList1)
  {
  ...
  private void createPostFillRadialExpansion(View paramView, long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, float paramFloat, @NonNull List<Animator> paramList)
  {
  ...
  private void createPreFillRadialExpansion(View paramView, long paramLong, int paramInt1, int paramInt2, float paramFloat, @NonNull List<Animator> paramList)
  {
  ...
  private void createTranslationAnimation(@NonNull View paramView1, @NonNull View paramView2, boolean paramBoolean1, boolean paramBoolean2, @NonNull FabTransformationSpec paramFabTransformationSpec, @NonNull List<Animator> paramList, List<Animator.AnimatorListener> paramList1, @NonNull RectF paramRectF)
  {
    float f1 = calculateTranslationX(paramView1, paramView2, paramFabTransformationSpec.positioning);
    float f2 = calculateTranslationY(paramView1, paramView2, paramFabTransformationSpec.positioning);
    ...
    {
      paramFabTransformationSpec = ObjectAnimator.ofFloat(paramView2, View.TRANSLATION_X, new float[] { -f1 });
      paramView1 = ObjectAnimator.ofFloat(paramView2, View.TRANSLATION_Y, new float[] { -f2 });
      paramView2 = paramFabTransformationSpec;
    }
    localMotionTiming1.apply(paramView2);
    localMotionTiming2.apply(paramView1);
    paramList.add(paramView2);
    paramList.add(paramView1);
  }
  
  private int getBackgroundTint(@NonNull View paramView)
  {
  ...
  @NonNull
  protected AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull final View paramView1, @NonNull final View paramView2, final boolean paramBoolean1, boolean paramBoolean2)
  {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\material\transformation\FabTransformationBehavior.class
