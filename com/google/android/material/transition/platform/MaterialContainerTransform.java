  ...
  extends Transition
{
    ...
    extends Drawable
  {
    ...
    private void updateProgress(float paramFloat)
    {
      ...
      f1 = ((Float)Preconditions.checkNotNull(Float.valueOf(MaterialContainerTransform.ProgressThresholdsGroup.access$600(this.progressThresholds).start))).floatValue();
      f2 = ((Float)Preconditions.checkNotNull(Float.valueOf(MaterialContainerTransform.ProgressThresholdsGroup.access$600(this.progressThresholds).end))).floatValue();
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\material\transition\platform\MaterialContainerTransform.class
