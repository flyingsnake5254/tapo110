...
final class IndicatorViewController
{
  ...
  private void createCaptionAnimators(@NonNull List<Animator> paramList, boolean paramBoolean, @Nullable TextView paramTextView, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private void setViewGroupGoneIfEmpty(@NonNull ViewGroup paramViewGroup, int paramInt)
  {
    if (paramInt == 0) {
  ...
  private boolean shouldAnimateCaptionView(@Nullable TextView paramTextView, @Nullable CharSequence paramCharSequence)
  {
    boolean bool;
  ...
  void setErrorContentDescription(@Nullable CharSequence paramCharSequence)
  {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\material\textfield\IndicatorViewController.class
