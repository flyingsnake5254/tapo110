  ...
  implements e0
{
  ...
  public PlayerView(Context paramContext, @Nullable AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public PlayerView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = p0.exo_player_view;
    if (paramAttributeSet != null) {
      localObject1 = paramContext.getTheme().obtainStyledAttributes(paramAttributeSet, t0.PlayerView, 0, 0);
    }
    boolean bool5;
    try
    {
      paramInt = t0.PlayerView_shutter_background_color;
      bool1 = ((TypedArray)localObject1).hasValue(paramInt);
      j = ((TypedArray)localObject1).getColor(paramInt, 0);
      i = ((TypedArray)localObject1).getResourceId(t0.PlayerView_player_layout_id, i);
      bool2 = ((TypedArray)localObject1).getBoolean(t0.PlayerView_use_artwork, true);
      paramInt = ((TypedArray)localObject1).getResourceId(t0.PlayerView_default_artwork, 0);
      bool3 = ((TypedArray)localObject1).getBoolean(t0.PlayerView_use_controller, true);
      k = ((TypedArray)localObject1).getInt(t0.PlayerView_surface_type, 1);
      m = ((TypedArray)localObject1).getInt(t0.PlayerView_resize_mode, 0);
      int n = ((TypedArray)localObject1).getInt(t0.PlayerView_show_timeout, 5000);
      bool4 = ((TypedArray)localObject1).getBoolean(t0.PlayerView_hide_on_touch, true);
      bool5 = ((TypedArray)localObject1).getBoolean(t0.PlayerView_auto_show, true);
      i1 = ((TypedArray)localObject1).getInteger(t0.PlayerView_show_buffering, 0);
      this.O3 = ((TypedArray)localObject1).getBoolean(t0.PlayerView_keep_content_on_player_reset, this.O3);
      bool6 = ((TypedArray)localObject1).getBoolean(t0.PlayerView_hide_during_ads, true);
    ...
    this.L3 = bool1;
    if (j != 0) {
      this.M3 = ContextCompat.getDrawable(getContext(), j);
    }
    ...
    j = n0.exo_controller;
    localObject2 = (PlayerControlView)findViewById(j);
    localObject1 = findViewById(n0.exo_controller_placeholder);
    if (localObject2 != null)
    {
      this.p2 = ((PlayerControlView)localObject2);
    }
    else if (localObject1 != null)
    {
      paramContext = new PlayerControlView(paramContext, null, 0, paramAttributeSet);
  ...
  private void E(boolean paramBoolean)
  {
    ...
    PlayerControlView localPlayerControlView = this.p2;
    int i;
    if (paramBoolean) {
      i = 0;
    } else {
  ...
  private void I()
  {
    PlayerControlView localPlayerControlView = this.p2;
    String str = null;
    if ((localPlayerControlView != null) && (this.J3))
    {
      if (localPlayerControlView.getVisibility() == 0)
      {
        if (this.U3) {
  ...
  private void x(boolean paramBoolean)
  {
    ...
    {
      int i;
      if ((this.p2.I()) && (this.p2.getShowTimeoutMs() <= 0)) {
        i = 1;
      } else {
        i = 0;
      }
  ...
  public void setControllerVisibilityListener(@Nullable PlayerControlView.d paramd)
  {
    g.i(this.p2);
    PlayerControlView.d locald = this.K3;
    if (locald == paramd) {
      return;
    }
    if (locald != null) {
  ...
  private final class a
    implements u1.e, View.OnLayoutChangeListener, View.OnClickListener, PlayerControlView.d
  {
    ...
    public void B(List<c> paramList)
    {
      if (PlayerView.a(PlayerView.this) != null) {
        PlayerView.a(PlayerView.this).B(paramList);
      }
    }
    
    public void G(TrackGroupArray paramTrackGroupArray, k paramk)
    {
      paramk = (u1)g.e(PlayerView.h(PlayerView.this));
      paramTrackGroupArray = paramk.w();
      ...
      {
        this.d = paramTrackGroupArray.g(paramk.H(), this.c, true).c;
      }
      else
      {
        ...
        if (localObject != null)
        {
          int i = paramTrackGroupArray.b(localObject);
          if (i != -1)
          {
    ...
    {
      PlayerView.d((TextureView)paramView, PlayerView.c(PlayerView.this));
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\google\android\exoplayer2\ui\PlayerView.class
