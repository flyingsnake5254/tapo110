...
public class ColorTemplate
{
  ...
  public static List<Integer> createColors(Resources paramResources, int[] paramArrayOfInt)
  {
    ...
    for (int j = 0; j < i; j++) {
      localArrayList.add(Integer.valueOf(paramResources.getColor(paramArrayOfInt[j])));
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\github\mikephil\charting\utils\ColorTemplate.class
