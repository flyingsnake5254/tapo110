  ...
  extends View
{
  ...
  public TPGifView(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public TPGifView(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public TPGifView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (localMovie != null)
    {
      int i = localMovie.width();
      paramInt2 = this.d.height();
      paramInt1 = View.MeasureSpec.getSize(paramInt1);
      float f1 = 1.0F / (i / paramInt1);
      this.p0 = f1;
      this.p1 = paramInt1;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\libtpcontrols\TPGifView.class
