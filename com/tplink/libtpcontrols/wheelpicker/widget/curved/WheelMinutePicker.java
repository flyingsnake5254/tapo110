  ...
  extends WheelCurvedPicker
{
  ...
  public WheelMinutePicker(Context paramContext)
  {
    super(paramContext);
    x();
  }
  
  public WheelMinutePicker(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    paramInt = Math.min(Math.max(paramInt, 0), 59);
    this.E4 = paramInt;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\libtpcontrols\wheelpicker\widget\curved\WheelMinutePicker.class
