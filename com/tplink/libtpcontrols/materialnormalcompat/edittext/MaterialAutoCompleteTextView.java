  ...
  extends AppCompatAutoCompleteTextView
{
  ...
  private void g0()
  {
    ...
    if (localObject == null)
    {
      ...
      localObject = AutoCompleteTextView.EMPTY_STATE_SET;
      int i = this.H3;
  ...
  private boolean o()
  {
    ...
    if ((localObject1 != null) && (this.Z4 != null))
    {
      ...
      if (this.Y4)
      {
        m = this.Z4[0].getWidth() + this.e5 + this.f5;
        break label101;
      }
    }
    else
    ...
    {
      if (((getGravity() & 0x800005) != 8388613) && (!d0()))
      {
        if ((getGravity() & 0x800003) == 8388611) {
  ...
  public boolean h0()
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      do
      {
        ...
        localObject = (com.tplink.libtpcontrols.materialnormalcompat.edittext.c.b)localIterator.next();
        if ((bool2) && (((com.tplink.libtpcontrols.materialnormalcompat.edittext.c.b)localObject).b(localEditable, bool1))) {
          bool3 = true;
        } else {
          bool3 = false;
        }
      ...
      setError(((com.tplink.libtpcontrols.materialnormalcompat.edittext.c.b)localObject).a());
      if (bool3) {
        setError(null);
      }
      postInvalidate();
  ...
  protected void onDraw(@NonNull Canvas paramCanvas)
  {
    ...
    if (localObject1 != null)
    {
      ...
      paramCanvas.drawBitmap((Bitmap)localObject1, i - i7 - i8, m + i1 - i9, this.A4);
    }
    localObject1 = this.o4;
    if (localObject1 != null)
    {
      ...
      i8 = ((Bitmap)localObject1).getWidth();
      m = this.p1;
      i7 = ((Bitmap)localObject1).getHeight();
      paramCanvas.drawBitmap((Bitmap)localObject1, i9 + n - i8, m + i1 - i7, this.A4);
    }
    int m = r();
    int i7 = t();
    ...
    if (!this.h4)
    {
      ...
      if (!b0())
      {
        ...
        paramCanvas.drawRect(m, i8, i1, L(2) + i8, this.A4);
      }
      else
      {
        j = i8;
    ...
    if (((hasFocus()) && (M())) || ((!a0()) && (this.a4 == null)))
    {
      ...
      localObject2 = getCharactersCounterText();
      localObject1 = C((CharSequence)localObject2);
      if (localObject1 != null)
      {
        paramCanvas.save();
        if (d0()) {
          paramCanvas.translate(this.S4 + i, this.p1 + i8 - f1);
        } else {
          paramCanvas.translate(n - this.B4.measureText((String)localObject2), this.p1 + i8 - f1);
        }
    ...
    if ((this.C4 != null) && ((this.a4 != null) || (((this.S3) || (hasFocus())) && (!TextUtils.isEmpty(this.Y3)))))
    {
      ...
      paramCanvas.save();
      if (d0()) {
        paramCanvas.translate(n - this.C4.getWidth() + this.S4, this.p1 + i8 - f1);
      } else {
        paramCanvas.translate(getBottomTextLeftOffset() + i, this.p1 + i8 - f1);
      }
      ...
      if ((this.O4 != null) && (!TextUtils.isEmpty(this.a4)))
      {
        ...
        this.A4.setFlags(1);
        if (d0()) {
          paramCanvas.drawBitmap((Bitmap)localObject1, j + i, i2, this.A4);
        } else {
          paramCanvas.drawBitmap((Bitmap)localObject1, n - m + k - i1, i2, this.A4);
        }
      }
    }
    if ((this.p2) && (!TextUtils.isEmpty(this.g4)))
    {
      ...
      if ((this.a4 != null) || (!a0()) || (this.k5 != null))
      {
        ...
        ((TextPaint)localObject2).setColor(((Integer)((ArgbEvaluator)localObject1).evaluate(f1 * f2, Integer.valueOf(m), Integer.valueOf(i1))).intValue());
      }
      f1 = this.B4.measureText(this.g4.toString());
      if (((getGravity() & 0x5) != 5) && (!d0()))
      {
        if ((getGravity() & 0x3) == 3) {
          m = i;
        } else {
          m = (int)(getInnerPaddingLeft() + (getWidth() - getInnerPaddingLeft() - getInnerPaddingRight() - f1) / 2.0F) + i;
        }
      }
      else {
        m = (int)(n - f1);
      ...
      m = this.I3 + this.x + this.p0 + (int)getTextSize();
      j = this.I3;
      k = this.x;
      ...
      f2 = getTextSize();
      f3 = getTextSize();
      this.B4.setTextSize((f6 - f2) * f1 + f3);
    ...
    if ((hasFocus()) && (this.Q3) && (getScrollX() != 0))
    {
      ...
      n = this.T3;
      paramCanvas.drawCircle(m * n / 2 + i, n / 2 + f1, n / 2, this.A4);
      n = this.T3;
      paramCanvas.drawCircle(m * n * 5 / 2 + i, n / 2 + f1, n / 2, this.A4);
      n = this.T3;
      paramCanvas.drawCircle(i + m * n * 9 / 2, f1 + n / 2, n / 2, this.A4);
    }
    ...
    implements TextWatcher
  {
    ...
    {
      if ((paramEditable.length() != 0) && (!MaterialAutoCompleteTextView.this.hasFocus())) {
        Selection.setSelection(MaterialAutoCompleteTextView.this.getText(), paramEditable.length());
      }
      MaterialAutoCompleteTextView.a(MaterialAutoCompleteTextView.this);
      if (MaterialAutoCompleteTextView.b(MaterialAutoCompleteTextView.this))
      {
    ...
    implements Animator.AnimatorListener
  {
    ...
    {
      if ((MaterialAutoCompleteTextView.d(MaterialAutoCompleteTextView.this)) && (MaterialAutoCompleteTextView.e(MaterialAutoCompleteTextView.this) == 0.0F))
      {
        if (TextUtils.isEmpty(MaterialAutoCompleteTextView.g(MaterialAutoCompleteTextView.this)))
        {
          paramAnimator = MaterialAutoCompleteTextView.this;
          MaterialAutoCompleteTextView.h(paramAnimator, MaterialAutoCompleteTextView.i(paramAnimator));
        }
        paramAnimator = MaterialAutoCompleteTextView.this;
        paramAnimator.setHint(MaterialAutoCompleteTextView.g(paramAnimator));
      }
    }
    ...
    implements TextWatcher
  {
    ...
    public void afterTextChanged(Editable paramEditable)
    {
      if ((MaterialAutoCompleteTextView.d(MaterialAutoCompleteTextView.this)) && (paramEditable.length() != 0) && (!MaterialAutoCompleteTextView.j(MaterialAutoCompleteTextView.this)))
      {
        MaterialAutoCompleteTextView.k(MaterialAutoCompleteTextView.this, true);
        MaterialAutoCompleteTextView.f(MaterialAutoCompleteTextView.this, 1.0F);
        paramEditable = MaterialAutoCompleteTextView.this;
        MaterialAutoCompleteTextView.h(paramEditable, paramEditable.getHint());
    ...
    implements View.OnFocusChangeListener
  {
    ...
    {
      if ((MaterialAutoCompleteTextView.d(MaterialAutoCompleteTextView.this)) && (MaterialAutoCompleteTextView.l(MaterialAutoCompleteTextView.this))) {
        if (paramBoolean) {
          MaterialAutoCompleteTextView.m(MaterialAutoCompleteTextView.this).start();
        } else {
          MaterialAutoCompleteTextView.m(MaterialAutoCompleteTextView.this).reverse();
        }
      }
      if (MaterialAutoCompleteTextView.d(MaterialAutoCompleteTextView.this)) {
        if (!paramBoolean)
        {
          if ((MaterialAutoCompleteTextView.j(MaterialAutoCompleteTextView.this)) && (TextUtils.isEmpty(MaterialAutoCompleteTextView.this.getText())))
          {
            MaterialAutoCompleteTextView.k(MaterialAutoCompleteTextView.this, false);
            MaterialAutoCompleteTextView.n(MaterialAutoCompleteTextView.this).reverse();
          }
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append("focus = 0 fs: ");
          ((StringBuilder)localObject).append(MaterialAutoCompleteTextView.j(MaterialAutoCompleteTextView.this));
          Log.i("material_debug", ((StringBuilder)localObject).toString());
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append("focus = 0 hint:");
          ((StringBuilder)localObject).append(MaterialAutoCompleteTextView.g(MaterialAutoCompleteTextView.this));
          Log.i("material_debug", ((StringBuilder)localObject).toString());
        }
        else
        {
          if (!MaterialAutoCompleteTextView.j(MaterialAutoCompleteTextView.this))
          {
            MaterialAutoCompleteTextView.k(MaterialAutoCompleteTextView.this, true);
            MaterialAutoCompleteTextView.n(MaterialAutoCompleteTextView.this).start();
            localObject = MaterialAutoCompleteTextView.this;
            MaterialAutoCompleteTextView.h((MaterialAutoCompleteTextView)localObject, ((AutoCompleteTextView)localObject).getHint());
            MaterialAutoCompleteTextView.this.setHint("");
          }
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append("focus != 0 fs: ");
      ...
      if ((MaterialAutoCompleteTextView.c(MaterialAutoCompleteTextView.this)) && (!paramBoolean)) {
        MaterialAutoCompleteTextView.this.h0();
      }
      Object localObject = MaterialAutoCompleteTextView.this.H4;
      if (localObject != null) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\libtpcontrols\materialnormalcompat\edittext\MaterialAutoCompleteTextView.class
