...
public class ActivityUpnpSettingBindingImpl
  extends ActivityUpnpSettingBinding
{
  @Nullable
  ...
  public ActivityUpnpSettingBindingImpl(@Nullable DataBindingComponent paramDataBindingComponent, @NonNull View paramView)
  {
    this(paramDataBindingComponent, paramView, ViewDataBinding.mapBindings(paramDataBindingComponent, paramView, 6, p0, p1));
  }
  
  private ActivityUpnpSettingBindingImpl(DataBindingComponent paramDataBindingComponent, View paramView, Object[] paramArrayOfObject)
  {
  ...
  protected void executeBindings()
  {
    try
    {
      long l = this.p3;
      this.p3 = 0L;
      UpnpSettingViewModel localUpnpSettingViewModel = this.y;
      boolean bool1 = false;
      boolean bool2 = false;
      boolean bool4;
      if ((0x1E & l) != 0L)
      {
        ...
        if ((l & 0x1A) != 0L)
        {
          if (localUpnpSettingViewModel != null) {
            localObject2 = localUpnpSettingViewModel.b;
          } else {
            localObject2 = null;
          }
        ...
        if ((l & 0x1C) != 0L)
        {
          ...
          if (localUpnpSettingViewModel != null) {
            localObject2 = localUpnpSettingViewModel.a;
          }
  ...
  public void h(@Nullable UpnpSettingViewModel paramUpnpSettingViewModel)
  {
    this.y = paramUpnpSettingViewModel;
    try
    {
      this.p3 |= 0x8;
  ...
  public boolean setVariable(int paramInt, @Nullable Object paramObject)
  {
    ...
    else
    {
      ...
      h((UpnpSettingViewModel)paramObject);
    }
    boolean bool = true;
    return bool;
    label36:
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\databinding\ActivityUpnpSettingBindingImpl.class
