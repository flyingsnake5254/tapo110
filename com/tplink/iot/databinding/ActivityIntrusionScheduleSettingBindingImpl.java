...
public class ActivityIntrusionScheduleSettingBindingImpl
  extends ActivityIntrusionScheduleSettingBinding
{
  @Nullable
  ...
  public ActivityIntrusionScheduleSettingBindingImpl(@Nullable DataBindingComponent paramDataBindingComponent, @NonNull View paramView)
  {
    this(paramDataBindingComponent, paramView, ViewDataBinding.mapBindings(paramDataBindingComponent, paramView, 14, M3, N3));
  }
  
  private ActivityIntrusionScheduleSettingBindingImpl(DataBindingComponent paramDataBindingComponent, View paramView, Object[] paramArrayOfObject)
  {
  ...
  protected void executeBindings()
  {
    try
    {
      ...
      AreaIntrusionScheduleViewModel localAreaIntrusionScheduleViewModel = this.J3;
      int i = 0;
      boolean bool1 = false;
      boolean bool2;
      long l2;
      ...
      if ((0x3B & l1) != 0L)
      {
        ...
        if ((l1 & 0x39) != 0L)
        {
          if (localAreaIntrusionScheduleViewModel != null) {
            localObject2 = localAreaIntrusionScheduleViewModel.g;
          } else {
            localObject2 = null;
          }
        ...
        if ((l2 & 0x32) != 0L)
        {
          ...
          if (localAreaIntrusionScheduleViewModel != null) {
            localObject2 = localAreaIntrusionScheduleViewModel.c;
          }
  ...
  public void i(@Nullable AreaIntrusionScheduleViewModel paramAreaIntrusionScheduleViewModel)
  {
    this.J3 = paramAreaIntrusionScheduleViewModel;
    try
    {
      this.P3 |= 0x10;
  ...
  public boolean setVariable(int paramInt, @Nullable Object paramObject)
  {
    ...
    else
    {
      ...
      i((AreaIntrusionScheduleViewModel)paramObject);
    }
    boolean bool = true;
    return bool;
    label53:
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\databinding\ActivityIntrusionScheduleSettingBindingImpl.class
