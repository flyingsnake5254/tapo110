...
public class DialogVolumeControlFullScreenBindingImpl
  extends DialogVolumeControlFullScreenBinding
{
  @Nullable
  ...
  public DialogVolumeControlFullScreenBindingImpl(@Nullable DataBindingComponent paramDataBindingComponent, @NonNull View paramView)
  {
    this(paramDataBindingComponent, paramView, ViewDataBinding.mapBindings(paramDataBindingComponent, paramView, 5, z, p0));
  }
  
  private DialogVolumeControlFullScreenBindingImpl(DataBindingComponent paramDataBindingComponent, View paramView, Object[] paramArrayOfObject)
  {
  ...
  protected void executeBindings()
  {
    try
    {
      ...
      label152:
      if ((l & 0xD) != 0L) {
        SeekBarBindingAdapter.setProgress(this.d, k);
      }
      if ((0x8 & l) != 0L)
      {
    ...
    implements InverseBindingListener
  {
    ...
    {
      int i = DialogVolumeControlFullScreenBindingImpl.this.d.getProgress();
      Object localObject = DialogVolumeControlFullScreenBindingImpl.this.y;
      int j = 1;
      int k;
      if (localObject != null) {
        k = 1;
    ...
    implements InverseBindingListener
  {
    ...
    public void onChange()
    {
      int i = DialogVolumeControlFullScreenBindingImpl.this.f.getProgress();
      Object localObject = DialogVolumeControlFullScreenBindingImpl.this.y;
      int j = 1;
      int k;
      if (localObject != null) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\databinding\DialogVolumeControlFullScreenBindingImpl.class
