...
public class PlayBackBottomBarBindingImpl
  extends PlayBackBottomBarBinding
  implements a.a
{
  @Nullable
  ...
  static
  {
    ...
    localSparseIntArray.put(2131362733, 3);
  }
  
  public PlayBackBottomBarBindingImpl(@Nullable DataBindingComponent paramDataBindingComponent, @NonNull View paramView)
  {
    this(paramDataBindingComponent, paramView, ViewDataBinding.mapBindings(paramDataBindingComponent, paramView, 4, y, z));
  }
  
  private PlayBackBottomBarBindingImpl(DataBindingComponent paramDataBindingComponent, View paramView, Object[] paramArrayOfObject)
  {
    super(paramDataBindingComponent, paramView, 4, (CheckBox)paramArrayOfObject[1], (CheckBox)paramArrayOfObject[2], (View)paramArrayOfObject[3]);
    this.c.setTag(null);
    this.d.setTag(null);
    ...
    implements InverseBindingListener
  {
    ...
    {
      boolean bool = PlayBackBottomBarBindingImpl.this.c.isChecked();
      Object localObject = PlayBackBottomBarBindingImpl.this.x;
      int i = 1;
      int j;
      if (localObject != null) {
        j = 1;
    ...
    implements InverseBindingListener
  {
    ...
    public void onChange()
    {
      boolean bool = PlayBackBottomBarBindingImpl.this.d.isChecked();
      Object localObject = PlayBackBottomBarBindingImpl.this.x;
      int i = 1;
      int j;
      if (localObject != null) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\databinding\PlayBackBottomBarBindingImpl.class
