...
public class CameraWiredConnectApViewModel
  extends OnBoardingFragmentViewModel
{
  private final MutableLiveData<a<Integer>> a = new MutableLiveData();
  private final MutableLiveData<a<Boolean>> b = new MutableLiveData();
  private b c = new b();
  private CameraOnBoardingViewModel d;
  
  public CameraWiredConnectApViewModel(@NonNull Application paramApplication)
  {
  ...
  public void f()
  {
    c localc = this.d.N().v().H0(new g1(this), new j1(this));
    this.c.b(localc);
  }
  ...
  public void g()
  {
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = ((OnBoardingRepository)localObject1).t((Wifi)localObject2, j.d((String)str)).H0(new h1(this), new i1(this));
      this.c.b((c)localObject2);
    }
    else
    {
      this.b.postValue(new a(Boolean.FALSE));
    }
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\viewmodel\ipcamera\onboardingv2\CameraWiredConnectApViewModel.class
