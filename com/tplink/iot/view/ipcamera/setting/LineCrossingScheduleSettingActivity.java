...
public class LineCrossingScheduleSettingActivity
  extends AppCompatActivity
  implements View.OnClickListener
{
  private LineCrossingScheduleViewModel c;
  private ActivityLineCrossingScheduleSettingBinding d;
  private int f = 3;
  ...
  {
    Intent localIntent = new Intent(paramContext, LineCrossingScheduleSettingActivity.class);
  ...
  private void a1()
  {
    new UniversalDialog.a().q(getString(2131953726)).s(getString(2131952391)).u(getString(2131952395)).t(new s2(this)).l().show(getSupportFragmentManager(), "CLEAR");
  }
  ...
  private void d1()
  {
    ...
    if (localToolbar != null)
    {
      ...
      localToolbar.setNavigationOnClickListener(new q2(this));
    }
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.f = getIntent().getIntExtra("detection_home_mode", 3);
    this.d = ((ActivityLineCrossingScheduleSettingBinding)DataBindingUtil.setContentView(this, 2131558572));
    paramBundle = (LineCrossingScheduleViewModel)ViewModelProviders.of(this, new CameraViewModelFactory(this, paramBundle)).get(LineCrossingScheduleViewModel.class);
    this.c = paramBundle;
    this.d.i(paramBundle);
    this.d.h(this);
    d1();
    P0();
    this.c.i().observe(this, new r2(this));
    this.c.j(this.f);
    this.c.u();
    j.c(this.c.i, this, new t2(this));
  }
}


/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\view\ipcamera\setting\LineCrossingScheduleSettingActivity.class
