  ...
  implements d
{
  public boolean a(BaseALIoTDevice<?> paramBaseALIoTDevice)
  {
    ...
    boolean bool = true;
    int i;
    if ((localEnumDeviceType != null) && (a.a.contains(localEnumDeviceType))) {
      i = 1;
    } else {
      i = 0;
    }
    ...
    if ((j == 0) && (a.b.contains(paramBaseALIoTDevice))) {
      j = 1;
    } else {
      j = 0;
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\view\smart\b\h.class
