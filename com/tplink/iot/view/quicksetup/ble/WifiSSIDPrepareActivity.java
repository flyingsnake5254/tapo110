...
public class WifiSSIDPrepareActivity
  ...
  implements View.OnClickListener
{
    ...
    implements View.OnClickListener
  {
    ...
    public void onClick(View paramView)
    {
      if (WifiSSIDPrepareActivity.e1(WifiSSIDPrepareActivity.this) != null) {
        WifiSSIDPrepareActivity.e1(WifiSSIDPrepareActivity.this).dismiss();
      }
    }
  }
    ...
    implements View.OnClickListener
  {
    ...
    public void onClick(View paramView)
    {
      ...
      WifiSSIDPrepareActivity.f1(WifiSSIDPrepareActivity.this);
    }
  }
    ...
    implements com.tplink.iot.view.quicksetup.base.wifi.a
  {
    ...
    public void a()
    {
      if ((!ActivityCompat.shouldShowRequestPermissionRationale(WifiSSIDPrepareActivity.this, "android.permission.ACCESS_COARSE_LOCATION")) || (!ActivityCompat.shouldShowRequestPermissionRationale(WifiSSIDPrepareActivity.this, "android.permission.ACCESS_FINE_LOCATION"))) {
        WifiSSIDPrepareActivity.this.z1();
      }
    }
    
    public void b()
    {
      WifiSSIDPrepareActivity.g1(WifiSSIDPrepareActivity.this);
      WifiSSIDPrepareActivity.h1(WifiSSIDPrepareActivity.this);
    }
  }
    ...
    implements com.tplink.iot.view.quicksetup.base.broadcast.wifi.a
  {
    ...
    public void a()
    {
      WifiSSIDPrepareActivity.i1(WifiSSIDPrepareActivity.this, false);
    }
    
    public void b()
    {
      WifiSSIDPrepareActivity.i1(WifiSSIDPrepareActivity.this, true);
      WifiSSIDPrepareActivity.j1(WifiSSIDPrepareActivity.this).postDelayed(new a(), 200L);
    }
    
    public void c()
    {
      WifiSSIDPrepareActivity.k1(WifiSSIDPrepareActivity.this).setVisibility(8);
      WifiSSIDPrepareActivity.l1(WifiSSIDPrepareActivity.this).setVisibility(0);
      WifiSSIDPrepareActivity.l1(WifiSSIDPrepareActivity.this).h();
    }
      ...
      implements Runnable
    {
      ...
      public void run()
      {
        if ((!WifiSSIDPrepareActivity.this.isDestroyed()) && (!WifiSSIDPrepareActivity.this.isFinishing())) {
          WifiSSIDPrepareActivity.h1(WifiSSIDPrepareActivity.this);
        }
      }
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\view\quicksetup\ble\WifiSSIDPrepareActivity.class
