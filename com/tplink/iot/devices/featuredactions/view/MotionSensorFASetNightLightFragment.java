...
public final class MotionSensorFASetNightLightFragment
  extends AbstractFeaturedActionFragment<MotionSensorFeaturedActionViewModel>
{
  ...
  public String a1()
  {
    String str = getString(2131953716);
    j.d(str, "getString(R.string.scene_set_night_light_desc)");
    return str;
  }
  ...
  public String f1()
  {
    String str = getString(2131953717);
    j.d(str, "getString(R.string.scene_set_night_light_title)");
    return str;
  }
  ...
  public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> paramList)
  {
    ...
    return new SmartInfo[] { ((MotionSensorFeaturedActionViewModel)b1()).K(f1(), paramList) };
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\devices\featuredactions\view\MotionSensorFASetNightLightFragment.class
