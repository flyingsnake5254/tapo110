...
public final class HubFASleepWithPeaceOfMindFragment
  extends AbstractFeaturedActionFragment<HubFeaturedActionViewModel>
{
  ...
  public String f1()
  {
    String str = getString(2131953721);
    j.d(str, "getString(R.string.scene…with_peace_of_mind_title)");
    return str;
  }
  ...
  public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> paramList)
  {
    ...
    return new SmartInfo[] { ((HubFeaturedActionViewModel)b1()).N(f1(), paramList) };
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\devices\featuredactions\view\HubFASleepWithPeaceOfMindFragment.class
