...
public final class HubFASecureDoorOrWindowFragment
  extends AbstractFeaturedActionFragment<HubFeaturedActionViewModel>
{
  ...
  public boolean W0(BaseALIoTDevice<?> paramBaseALIoTDevice)
  {
    ...
    if (localThingModel != null)
    {
      ...
      {
        bool2 = bool1;
        if (s1(localThingModel, "keepOpen")) {
          bool2 = true;
        }
      }
    }
  ...
  public String a1()
  {
    String str = getString(2131953712);
    j.d(str, "getString(R.string.scene…cure_door_or_window_desc)");
    return str;
  }
  ...
  {
    return l.b(EnumIoTCategory.SUBG_TRIGGER_CONTACT_SENSOR);
  }
  
  public String f1()
  {
    String str = getString(2131953713);
    j.d(str, "getString(R.string.scene…ure_door_or_window_title)");
    return str;
  }
  ...
  public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> paramList)
  {
    ...
    return new SmartInfo[] { ((HubFeaturedActionViewModel)b1()).M(f1(), paramList) };
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\devices\featuredactions\view\HubFASecureDoorOrWindowFragment.class
