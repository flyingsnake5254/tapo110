...
public final class ButtonFATurnOnOffDeviceFragment
  extends AbstractFeaturedActionFragment<ButtonFeaturedActionViewModel>
{
  ...
  public boolean W0(BaseALIoTDevice<?> paramBaseALIoTDevice)
  {
    ...
    if (localThingModel != null)
    {
      ...
      {
        bool2 = bool1;
        if (u1(localThingModel, "reverseStatus")) {
          bool2 = true;
        }
      }
    }
  ...
  public String a1()
  {
    String str = getString(2131953724);
    j.d(str, "getString(R.string.scene_turn_on_off_device_desc)");
    return str;
  }
  ...
  public String f1()
  {
    String str = getString(2131953725);
    j.d(str, "getString(R.string.scene_turn_on_off_device_title)");
    return str;
  }
  ...
  public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> paramList)
  {
    ...
    return new SmartInfo[] { ((ButtonFeaturedActionViewModel)b1()).N(f1(), paramList) };
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\devices\featuredactions\view\ButtonFATurnOnOffDeviceFragment.class
