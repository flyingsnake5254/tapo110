...
public final class HubFABuildSmartDoorbellFragment
  extends AbstractFeaturedActionFragment<HubFeaturedActionViewModel>
{
  ...
  public String a1()
  {
    String str = getString(2131953691);
    j.d(str, "getString(R.string.scene…_smart_doorbell_hub_desc)");
    return str;
  }
  ...
  public String f1()
  {
    String str = getString(2131953692);
    j.d(str, "getString(R.string.scene…smart_doorbell_hub_title)");
    return str;
  }
  ...
  public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> paramList)
  {
    ...
    return new SmartInfo[] { ((HubFeaturedActionViewModel)b1()).K(f1(), paramList) };
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\devices\featuredactions\view\HubFABuildSmartDoorbellFragment.class
