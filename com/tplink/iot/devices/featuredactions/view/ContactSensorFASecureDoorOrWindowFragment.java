...
public final class ContactSensorFASecureDoorOrWindowFragment
  extends AbstractFeaturedActionFragment<ContactSensorFeaturedActionViewModel>
{
  ...
  public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> paramList)
  {
    ...
    return new SmartInfo[] { ((ContactSensorFeaturedActionViewModel)b1()).L(f1(), paramList) };
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\com\tplink\iot\devices\featuredactions\view\ContactSensorFASecureDoorOrWindowFragment.class
