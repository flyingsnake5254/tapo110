  ...
  extends WebSocketClientHandshaker
{
  ...
  public WebSocketClientHandshaker07(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean, HttpHeaders paramHttpHeaders, int paramInt)
  {
    this(paramURI, paramWebSocketVersion, paramString, paramBoolean, paramHttpHeaders, paramInt, true, false);
  }
  
  public WebSocketClientHandshaker07(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean1, HttpHeaders paramHttpHeaders, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
  ...
  public WebSocketClientHandshaker07(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean1, HttpHeaders paramHttpHeaders, int paramInt, boolean paramBoolean2, boolean paramBoolean3, long paramLong)
  {
  ...
  WebSocketClientHandshaker07(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean1, HttpHeaders paramHttpHeaders, int paramInt, boolean paramBoolean2, boolean paramBoolean3, long paramLong, boolean paramBoolean4)
  {
  ...
  protected FullHttpRequest newHandshakeRequest()
  {
    ...
    if (((InternalLogger)localObject3).isDebugEnabled()) {
      ((InternalLogger)localObject3).debug("WebSocket version 07 client handshake key: {}, expected response: {}", localObject2, this.expectedChallengeResponseString);
    }
    DefaultFullHttpRequest localDefaultFullHttpRequest = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, upgradeUrl((URI)localObject1), Unpooled.EMPTY_BUFFER);
    localObject3 = localDefaultFullHttpRequest.headers();
    Object localObject4 = this.customHeaders;
    if (localObject4 != null)
    {
      ((HttpHeaders)localObject3).add((HttpHeaders)localObject4);
      localObject4 = HttpHeaderNames.HOST;
      if (!((HttpHeaders)localObject3).contains((CharSequence)localObject4)) {
        ((HttpHeaders)localObject3).set((CharSequence)localObject4, WebSocketClientHandshaker.websocketHostValue((URI)localObject1));
      }
    }
    else
    {
      ((HttpHeaders)localObject3).set(HttpHeaderNames.HOST, WebSocketClientHandshaker.websocketHostValue((URI)localObject1));
    }
    ((HttpHeaders)localObject3).set(HttpHeaderNames.UPGRADE, HttpHeaderValues.WEBSOCKET).set(HttpHeaderNames.CONNECTION, HttpHeaderValues.UPGRADE).set(HttpHeaderNames.SEC_WEBSOCKET_KEY, localObject2);
    localObject2 = HttpHeaderNames.SEC_WEBSOCKET_ORIGIN;
    if (!((HttpHeaders)localObject3).contains((CharSequence)localObject2)) {
      ((HttpHeaders)localObject3).set((CharSequence)localObject2, WebSocketClientHandshaker.websocketOriginValue((URI)localObject1));
    }
    localObject1 = expectedSubprotocol();
    if ((localObject1 != null) && (!((String)localObject1).isEmpty())) {
      ((HttpHeaders)localObject3).set(HttpHeaderNames.SEC_WEBSOCKET_PROTOCOL, localObject1);
    }
    ((HttpHeaders)localObject3).set(HttpHeaderNames.SEC_WEBSOCKET_VERSION, version().toAsciiString());
    return localDefaultFullHttpRequest;
  }
  ...
  public WebSocketClientHandshaker07 setForceCloseTimeoutMillis(long paramLong)
  {
