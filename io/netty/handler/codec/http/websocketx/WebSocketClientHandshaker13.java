  ...
  extends WebSocketClientHandshaker
{
  ...
  public WebSocketClientHandshaker13(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean1, HttpHeaders paramHttpHeaders, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
  ...
  public WebSocketClientHandshaker13(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean1, HttpHeaders paramHttpHeaders, int paramInt, boolean paramBoolean2, boolean paramBoolean3, long paramLong)
  {
  ...
  WebSocketClientHandshaker13(URI paramURI, WebSocketVersion paramWebSocketVersion, String paramString, boolean paramBoolean1, HttpHeaders paramHttpHeaders, int paramInt, boolean paramBoolean2, boolean paramBoolean3, long paramLong, boolean paramBoolean4)
  {
  ...
  protected FullHttpRequest newHandshakeRequest()
  {
    ...
    if (((InternalLogger)localObject3).isDebugEnabled()) {
      ((InternalLogger)localObject3).debug("WebSocket version 13 client handshake key: {}, expected response: {}", localObject2, this.expectedChallengeResponseString);
    }
    ...
    localObject2 = HttpHeaderNames.ORIGIN;
  ...
  public WebSocketClientHandshaker13 setForceCloseTimeoutMillis(long paramLong)
  {
  ...
  protected void verify(FullHttpResponse paramFullHttpResponse)
  {
    ...
    if (paramFullHttpResponse.status().equals(localObject1))
    {
      ...
      {
        paramFullHttpResponse = HttpHeaderNames.CONNECTION;
        if (((HttpHeaders)localObject2).containsValue(paramFullHttpResponse, HttpHeaderValues.UPGRADE, true))
        {
        ...
        ((StringBuilder)localObject1).append("Invalid handshake response connection: ");
        ((StringBuilder)localObject1).append(((HttpHeaders)localObject2).get(paramFullHttpResponse));
