  ...
  extends WebSocketServerHandshaker
{
  ...
  public WebSocketServerHandshaker07(String paramString1, String paramString2, WebSocketDecoderConfig paramWebSocketDecoderConfig)
  {
    super(WebSocketVersion.V07, paramString1, paramString2, paramWebSocketDecoderConfig);
  }
  ...
  public WebSocketServerHandshaker07(String paramString1, String paramString2, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
  ...
  protected FullHttpResponse newHandshakeResponse(FullHttpRequest paramFullHttpRequest, HttpHeaders paramHttpHeaders)
  {
    ...
    if (localObject != null)
    {
      ...
      if (paramHttpHeaders.isDebugEnabled()) {
        paramHttpHeaders.debug("WebSocket version 07 server handshake key: {}, response: {}.", localObject, str);
      }
