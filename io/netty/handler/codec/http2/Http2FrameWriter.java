  ...
  extends Http2DataWriter, Closeable
{
  ...
  public abstract ChannelFuture writePing(ChannelHandlerContext paramChannelHandlerContext, boolean paramBoolean, long paramLong, ChannelPromise paramChannelPromise);
  ...
  public static abstract interface Configuration
  {
    ...
    public abstract Http2HeadersEncoder.Configuration headersConfiguration();
  }
}
