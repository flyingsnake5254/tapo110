  ...
  implements FullBinaryMemcacheRequest
{
  ...
  public DefaultFullBinaryMemcacheRequest(ByteBuf paramByteBuf1, ByteBuf paramByteBuf2)
  {
    this(paramByteBuf1, paramByteBuf2, Unpooled.buffer(0));
  }
  
  public DefaultFullBinaryMemcacheRequest(ByteBuf paramByteBuf1, ByteBuf paramByteBuf2, ByteBuf paramByteBuf3)
  {
  ...
  private DefaultFullBinaryMemcacheRequest newInstance(ByteBuf paramByteBuf1, ByteBuf paramByteBuf2, ByteBuf paramByteBuf3)
  {
    paramByteBuf1 = new DefaultFullBinaryMemcacheRequest(paramByteBuf1, paramByteBuf2, paramByteBuf3);
  ...
  public FullBinaryMemcacheRequest replace(ByteBuf paramByteBuf)
  {
    Object localObject1 = key();
    Object localObject2 = localObject1;
    if (localObject1 != null) {
  ...
  public FullBinaryMemcacheRequest retain(int paramInt)
  {
  ...
  public FullBinaryMemcacheRequest touch(Object paramObject)
  {
