...
{
  private static final ObjectPool<PooledDuplicatedByteBuf> RECYCLER = ObjectPool.newPool(new ObjectPool.ObjectCreator()
  {
    public PooledDuplicatedByteBuf newObject(ObjectPool.Handle<PooledDuplicatedByteBuf> paramAnonymousHandle)
    {
      return new PooledDuplicatedByteBuf(paramAnonymousHandle, null);
    }
  });
  
  private PooledDuplicatedByteBuf(ObjectPool.Handle<PooledDuplicatedByteBuf> paramHandle)
  {
    super(paramHandle);
  }
  
  static PooledDuplicatedByteBuf newInstance(AbstractByteBuf paramAbstractByteBuf, ByteBuf paramByteBuf, int paramInt1, int paramInt2)
  {
    PooledDuplicatedByteBuf localPooledDuplicatedByteBuf = (PooledDuplicatedByteBuf)RECYCLER.get();
    localPooledDuplicatedByteBuf.init(paramAbstractByteBuf, paramByteBuf, paramInt1, paramInt2, paramAbstractByteBuf.maxCapacity());
    localPooledDuplicatedByteBuf.markReaderIndex();
    localPooledDuplicatedByteBuf.markWriterIndex();
    return localPooledDuplicatedByteBuf;
  }
