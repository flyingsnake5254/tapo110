  ...
  implements Interceptor
{
    ...
    throws IOException
  {
    ...
    {
      localObject1 = new GzipSource(paramChain.body().source());
      ...
      ((Response.Builder)localObject2).body(new RealResponseBody(paramChain.header("Content-Type"), -1L, Okio.buffer((Source)localObject1)));
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\internal\http\BridgeInterceptor.class
