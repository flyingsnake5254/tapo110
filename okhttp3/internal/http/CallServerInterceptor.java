    ...
    if (bool)
    {
      ...
      if (localRequest.body() != null)
      {
        ...
        if (localObject == null)
        {
          ...
          paramChain = Okio.buffer(localCountingSink);
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\internal\http\CallServerInterceptor.class
