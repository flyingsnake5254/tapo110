  ...
  extends Platform
{
  ...
  public static Platform buildIfSupported()
  {
    ...
    localOptionalMethod1 = new okhttp3/internal/platform/OptionalMethod;
    localOptionalMethod1.<init>(null, "setUseSessionTickets", new Class[] { Boolean.TYPE });
    localOptionalMethod2 = new okhttp3/internal/platform/OptionalMethod;
    ...
    throws IOException
  {
    if (paramString != null)
    {
      this.setUseSessionTickets.invokeOptionalWithoutCheckedException(paramSSLSocket, new Object[] { Boolean.TRUE });
  ...
  {
    Object localObject1 = Platform.readFieldOrNull(paramSSLSocketFactory, this.sslParametersClass, "sslParameters");
    Object localObject2 = localObject1;
    if (localObject1 == null) {
      try
      {
        localObject2 = Platform.readFieldOrNull(paramSSLSocketFactory, Class.forName("com.google.android.gms.org.conscrypt.SSLParametersImpl", false, paramSSLSocketFactory.getClass().getClassLoader()), "sslParameters");
      }
      catch (ClassNotFoundException localClassNotFoundException)
      {
    ...
    paramSSLSocketFactory = (X509TrustManager)Platform.readFieldOrNull(localClassNotFoundException, X509TrustManager.class, "x509TrustManager");
    if (paramSSLSocketFactory != null) {
      return paramSSLSocketFactory;
    }
    return (X509TrustManager)Platform.readFieldOrNull(localClassNotFoundException, X509TrustManager.class, "trustManager");
  }
  ...
  static final class CloseGuard
  {
    ...
    static CloseGuard get()
    {
      ...
      return new CloseGuard((Method)localObject1, (Method)localObject3, (Method)localObject4);
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\internal\platform\AndroidPlatform.class
