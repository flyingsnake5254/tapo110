  ...
  extends Platform
{
  ...
  {
    paramString = Platform.alpnProtocolNames(paramList);
    try
    {
      ...
      localJettyNegoProvider.<init>(paramString);
      paramString = Proxy.newProxyInstance(localClassLoader, new Class[] { paramList, localClass }, localJettyNegoProvider);
  ...
  public String getSelectedProtocol(SSLSocket paramSSLSocket)
  {
    try
    {
      ...
      boolean bool = paramSSLSocket.unsupported;
      if ((!bool) && (paramSSLSocket.selected == null))
      {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\internal\platform\JdkWithJettyBootPlatform.class
