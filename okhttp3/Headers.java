...
public final class Headers
{
  ...
  {
    paramBuilder = paramBuilder.namesAndValues;
    this.namesAndValues = ((String[])paramBuilder.toArray(new String[paramBuilder.size()]));
  }
  ...
  public static Headers of(Map<String, String> paramMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        paramMap = ((String)((Map.Entry)localObject).getKey()).trim();
        localObject = ((String)((Map.Entry)localObject).getValue()).trim();
        checkName(paramMap);
        checkValue((String)localObject, paramMap);
        arrayOfString[i] = paramMap;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\Headers.class
