...
public final class CipherSuite
{
  ...
  static final Comparator<String> ORDER_BY_NAME = new Comparator()
  {
    public int compare(String paramAnonymousString1, String paramAnonymousString2)
    {
      ...
      for (int j = 4;; j++)
      {
        ...
        int m = paramAnonymousString1.charAt(j);
        int n = paramAnonymousString2.charAt(j);
        if (m != n)
        {
          if (m >= n) {
            k = 1;
  ...
  public static CipherSuite forJavaName(String paramString)
  {
    try
    {
      ...
      CipherSuite localCipherSuite1 = (CipherSuite)localMap.get(paramString);
      CipherSuite localCipherSuite2 = localCipherSuite1;
      if (localCipherSuite1 == null)
      {
        localCipherSuite1 = (CipherSuite)localMap.get(secondaryName(paramString));
        ...
        localMap.put(paramString, localCipherSuite2);
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\CipherSuite.class
