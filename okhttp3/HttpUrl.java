...
public final class HttpUrl
{
  ...
  HttpUrl(Builder paramBuilder)
  {
    ...
    String str = paramBuilder.encodedFragment;
    ...
    for (Object localObject1 = null; paramInt1 < paramInt2; localObject1 = localObject2)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          localObject1 = HEX_DIGITS;
          paramBuffer.writeByte(localObject1[(j >> 4 & 0xF)]);
          paramBuffer.writeByte(localObject1[(j & 0xF)]);
        }
      }
      label321:
  ...
  public static final class Builder
  {
    ...
    {
      Objects.requireNonNull(paramString, "encodedPathSegment == null");
    ...
    {
      Objects.requireNonNull(paramString, "encodedPathSegments == null");
    ...
    {
      Objects.requireNonNull(paramString1, "encodedName == null");
    ...
    {
      Objects.requireNonNull(paramString, "pathSegment == null");
    ...
    {
      Objects.requireNonNull(paramString, "pathSegments == null");
    ...
    {
      Objects.requireNonNull(paramString, "encodedPassword == null");
    ...
    {
      Objects.requireNonNull(paramString, "encodedPath == null");
    ...
    {
      Objects.requireNonNull(paramString, "encodedUsername == null");
    ...
    Builder parse(@Nullable HttpUrl paramHttpUrl, String paramString)
    {
      ...
      else
      {
        ...
        k = portColonOffset(paramString, m, n);
        i = k + 1;
        if (i < n)
        {
          this.host = canonicalizeHost(paramString, m, k);
          i1 = parsePort(paramString, i, n);
          this.port = i1;
          if (i1 == -1)
          {
            paramHttpUrl = new StringBuilder();
            paramHttpUrl.append("Invalid URL port: \"");
            paramHttpUrl.append(paramString.substring(i, n));
            paramHttpUrl.append('"');
            throw new IllegalArgumentException(paramHttpUrl.toString());
          }
        }
      ...
      paramHttpUrl.append(paramString.substring(m, k));
      paramHttpUrl.append('"');
      throw new IllegalArgumentException(paramHttpUrl.toString());
      label854:
    ...
    {
      Objects.requireNonNull(paramString, "encodedName == null");
      if (this.encodedQueryNamesAndValues == null) {
        return this;
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\okhttp3\HttpUrl.class
