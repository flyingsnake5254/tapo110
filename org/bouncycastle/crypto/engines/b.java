  ...
  implements c
{
  ...
  private int c(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    while (m < 4)
    {
      n = (n << 8) + (paramArrayOfByte[(m + paramInt)] & 0xFF);
      m++;
    }
    return n;
  }
  
  private void e(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    int m = paramArrayOfInt1[0] ^ paramArrayOfInt2[(paramInt + 0)];
    int[] arrayOfInt1 = c;
    int n = arrayOfInt1[(m & 0xFF)];
    int[] arrayOfInt2 = e;
    int i1 = arrayOfInt2[(m >>> 8 & 0xFF)];
    int[] arrayOfInt3 = d;
    int i2 = arrayOfInt3[(m >>> 16 & 0xFF)];
    int[] arrayOfInt4 = b;
    n = arrayOfInt4[(m >>> 24 & 0xFF)] ^ n ^ i1 ^ i2;
    m = paramArrayOfInt1[1] ^ paramArrayOfInt2[(paramInt + 1)];
    i1 = arrayOfInt4[(m & 0xFF)];
    i2 = arrayOfInt1[(m >>> 8 & 0xFF)];
    int i3 = arrayOfInt2[(m >>> 16 & 0xFF)];
    int i4 = arrayOfInt3[(m >>> 24 & 0xFF)];
    m = paramArrayOfInt1[2];
    i1 = i4 ^ i1 ^ i2 ^ i3 ^ n;
    paramArrayOfInt1[2] = (m ^ i1);
    m = paramArrayOfInt1[3];
    paramArrayOfInt1[3] = (m(n, 8) ^ i1 ^ m);
    i2 = paramArrayOfInt1[2] ^ paramArrayOfInt2[(paramInt + 2)];
    i1 = arrayOfInt1[(i2 & 0xFF)];
    m = arrayOfInt2[(i2 >>> 8 & 0xFF)];
    n = arrayOfInt3[(i2 >>> 16 & 0xFF)];
    n = arrayOfInt4[(i2 >>> 24 & 0xFF)] ^ i1 ^ m ^ n;
    i1 = paramArrayOfInt1[3];
    i1 = paramArrayOfInt2[(paramInt + 3)] ^ i1;
    m = arrayOfInt4[(i1 & 0xFF)];
    i2 = arrayOfInt1[(i1 >>> 8 & 0xFF)];
    paramInt = arrayOfInt2[(i1 >>> 16 & 0xFF)];
    i3 = arrayOfInt3[(i1 >>> 24 & 0xFF)];
    i1 = paramArrayOfInt1[0];
    paramInt = i3 ^ m ^ i2 ^ paramInt ^ n;
    paramArrayOfInt1[0] = (i1 ^ paramInt);
    i1 = paramArrayOfInt1[1];
    paramArrayOfInt1[1] = (paramInt ^ m(n, 8) ^ i1);
  }
  
  private void f(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    paramArrayOfInt1[1] ^= j(paramArrayOfInt1[0] & paramArrayOfInt2[(paramInt + 0)], 1);
    ...
    paramArrayOfInt1[3] = (j(paramArrayOfInt2[(paramInt + 2)] & paramArrayOfInt1[2], 1) ^ m);
  }
  
  private static void g(int paramInt1, int[] paramArrayOfInt1, int paramInt2, int[] paramArrayOfInt2, int paramInt3)
  {
    int m = paramInt3 + 2;
    int n = paramInt2 + 0;
    int i1 = paramArrayOfInt1[n];
    int i2 = paramInt2 + 1;
    int i3 = paramArrayOfInt1[i2];
    int i4 = 32 - paramInt1;
    paramArrayOfInt2[m] = (i1 << paramInt1 | i3 >>> i4);
    i3 = paramInt3 + 3;
    int i5 = paramArrayOfInt1[i2];
    i1 = paramInt2 + 2;
    paramArrayOfInt2[i3] = (i5 << paramInt1 | paramArrayOfInt1[i1] >>> i4);
    i5 = paramInt3 + 0;
    int i6 = paramArrayOfInt1[i1];
    paramInt2 += 3;
    paramArrayOfInt2[i5] = (i6 << paramInt1 | paramArrayOfInt1[paramInt2] >>> i4);
    paramInt3++;
    paramArrayOfInt2[paramInt3] = (paramArrayOfInt1[paramInt2] << paramInt1 | paramArrayOfInt1[n] >>> i4);
    paramArrayOfInt1[n] = paramArrayOfInt2[m];
    paramArrayOfInt1[i2] = paramArrayOfInt2[i3];
    paramArrayOfInt1[i1] = paramArrayOfInt2[i5];
    paramArrayOfInt1[paramInt2] = paramArrayOfInt2[paramInt3];
  }
  
  private static void h(int paramInt1, int[] paramArrayOfInt1, int paramInt2, int[] paramArrayOfInt2, int paramInt3)
  {
    int m = paramInt3 + 2;
    int n = paramInt2 + 1;
    int i1 = paramArrayOfInt1[n];
    ...
    paramArrayOfInt2[m] = (i1 << i2 | i4 >>> paramInt1);
    i4 = paramInt3 + 3;
    int i5 = paramArrayOfInt1[i3];
    i1 = paramInt2 + 3;
    paramArrayOfInt2[i4] = (i5 << i2 | paramArrayOfInt1[i1] >>> paramInt1);
    i5 = paramInt3 + 0;
    int i6 = paramArrayOfInt1[i1];
    paramInt2 += 0;
    paramArrayOfInt2[i5] = (i6 << i2 | paramArrayOfInt1[paramInt2] >>> paramInt1);
    paramInt3++;
    i6 = paramArrayOfInt1[paramInt2];
    paramArrayOfInt2[paramInt3] = (paramArrayOfInt1[n] >>> paramInt1 | i6 << i2);
    paramArrayOfInt1[paramInt2] = paramArrayOfInt2[m];
    paramArrayOfInt1[n] = paramArrayOfInt2[i4];
    paramArrayOfInt1[i3] = paramArrayOfInt2[i5];
    paramArrayOfInt1[i1] = paramArrayOfInt2[paramInt3];
  }
  
  private void i(int paramInt1, byte[] paramArrayOfByte, int paramInt2)
  {
    int m = 0;
    int n = paramInt1;
    for (paramInt1 = m; paramInt1 < 4; paramInt1++)
    {
      paramArrayOfByte[(3 - paramInt1 + paramInt2)] = ((byte)(byte)n);
      n >>>= 8;
    }
  }
  ...
  private int k(byte[] paramArrayOfByte1, int paramInt1, byte[] paramArrayOfByte2, int paramInt2)
  {
    for (int m = 0; m < 4; m++)
    {
      this.k[m] = c(paramArrayOfByte1, m * 4 + paramInt1);
      arrayOfInt = this.k;
      arrayOfInt[m] ^= this.i[m];
    }
    e(this.k, this.h, 0);
    e(this.k, this.h, 4);
    e(this.k, this.h, 8);
    ...
    paramInt1 = arrayOfInt[2];
    paramArrayOfByte1 = this.i;
    arrayOfInt[2] = (paramArrayOfByte1[4] ^ paramInt1);
    arrayOfInt[3] ^= paramArrayOfByte1[5];
    arrayOfInt[0] ^= paramArrayOfByte1[6];
    paramInt1 = arrayOfInt[1];
    arrayOfInt[1] = (paramArrayOfByte1[7] ^ paramInt1);
    i(arrayOfInt[2], paramArrayOfByte2, paramInt2);
    i(this.k[3], paramArrayOfByte2, paramInt2 + 4);
    i(this.k[0], paramArrayOfByte2, paramInt2 + 8);
    i(this.k[1], paramArrayOfByte2, paramInt2 + 12);
    return 16;
  }
  
  private int l(byte[] paramArrayOfByte1, int paramInt1, byte[] paramArrayOfByte2, int paramInt2)
  {
    for (int m = 0; m < 4; m++)
    {
      this.k[m] = c(paramArrayOfByte1, m * 4 + paramInt1);
    ...
    paramInt1 = arrayOfInt[2];
    paramArrayOfByte1 = this.i;
    arrayOfInt[2] = (paramInt1 ^ paramArrayOfByte1[4]);
    arrayOfInt[3] ^= paramArrayOfByte1[5];
    arrayOfInt[0] ^= paramArrayOfByte1[6];
    paramInt1 = arrayOfInt[1];
    arrayOfInt[1] = (paramArrayOfByte1[7] ^ paramInt1);
  ...
  private static void n(int paramInt1, int[] paramArrayOfInt1, int paramInt2, int[] paramArrayOfInt2, int paramInt3)
  {
    int m = paramInt3 + 0;
    int n = paramInt2 + 0;
    int i1 = paramArrayOfInt1[n];
  ...
  private static void o(int paramInt1, int[] paramArrayOfInt1, int paramInt2, int[] paramArrayOfInt2, int paramInt3)
  {
    int m = paramInt3 + 0;
    int n = paramInt2 + 1;
    int i1 = paramArrayOfInt1[n];
    ...
    paramArrayOfInt2[i5] = (i6 << i2 | paramArrayOfInt1[paramInt2] >>> paramInt1);
    i6 = paramInt3 + 3;
    paramInt3 = paramArrayOfInt1[paramInt2];
    paramArrayOfInt2[i6] = (paramArrayOfInt1[n] >>> paramInt1 | paramInt3 << i2);
    paramArrayOfInt1[paramInt2] = paramArrayOfInt2[m];
    paramArrayOfInt1[n] = paramArrayOfInt2[i4];
    paramArrayOfInt1[i3] = paramArrayOfInt2[i5];
    paramArrayOfInt1[i1] = paramArrayOfInt2[i6];
  }
  
  private void p(boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    if (m != 16)
    {
      if (m != 24)
      {
        if (m == 32)
        {
          arrayOfInt1[0] = c(paramArrayOfByte, 0);
          arrayOfInt1[1] = c(paramArrayOfByte, 4);
          arrayOfInt1[2] = c(paramArrayOfByte, 8);
          arrayOfInt1[3] = c(paramArrayOfByte, 12);
          arrayOfInt1[4] = c(paramArrayOfByte, 16);
          arrayOfInt1[5] = c(paramArrayOfByte, 20);
          arrayOfInt1[6] = c(paramArrayOfByte, 24);
          arrayOfInt1[7] = c(paramArrayOfByte, 28);
        }
        else
        {
    ...
    if (this.g)
    {
      ...
      if (paramBoolean)
      {
        ...
        n(15, arrayOfInt1, 0, this.h, 4);
        n(30, arrayOfInt1, 0, this.h, 12);
        n(15, arrayOfInt1, 0, arrayOfInt4, 0);
        paramArrayOfByte = this.h;
        paramArrayOfByte[18] = arrayOfInt4[2];
        paramArrayOfByte[19] = arrayOfInt4[3];
        n(17, arrayOfInt1, 0, this.j, 4);
        n(17, arrayOfInt1, 0, this.h, 24);
        n(17, arrayOfInt1, 0, this.h, 32);
        paramArrayOfByte = this.h;
        paramArrayOfByte[0] = arrayOfInt2[0];
        paramArrayOfByte[1] = arrayOfInt2[1];
        paramArrayOfByte[2] = arrayOfInt2[2];
        paramArrayOfByte[3] = arrayOfInt2[3];
        n(15, arrayOfInt2, 0, paramArrayOfByte, 8);
        n(15, arrayOfInt2, 0, this.j, 0);
        n(15, arrayOfInt2, 0, arrayOfInt4, 0);
        paramArrayOfByte = this.h;
        paramArrayOfByte[16] = arrayOfInt4[0];
        paramArrayOfByte[17] = arrayOfInt4[1];
        n(15, arrayOfInt2, 0, paramArrayOfByte, 20);
        o(34, arrayOfInt2, 0, this.h, 28);
        n(17, arrayOfInt2, 0, this.i, 4);
      }
      else
      {
        paramArrayOfByte[4] = arrayOfInt1[0];
        paramArrayOfByte[5] = arrayOfInt1[1];
        paramArrayOfByte[6] = arrayOfInt1[2];
        paramArrayOfByte[7] = arrayOfInt1[3];
        g(15, arrayOfInt1, 0, this.h, 28);
        g(30, arrayOfInt1, 0, this.h, 20);
        g(15, arrayOfInt1, 0, arrayOfInt4, 0);
        paramArrayOfByte = this.h;
        paramArrayOfByte[16] = arrayOfInt4[0];
        paramArrayOfByte[17] = arrayOfInt4[1];
        g(17, arrayOfInt1, 0, this.j, 0);
        g(17, arrayOfInt1, 0, this.h, 8);
        g(17, arrayOfInt1, 0, this.h, 0);
        paramArrayOfByte = this.h;
        paramArrayOfByte[34] = arrayOfInt2[0];
        paramArrayOfByte[35] = arrayOfInt2[1];
        paramArrayOfByte[32] = arrayOfInt2[2];
        paramArrayOfByte[33] = arrayOfInt2[3];
        g(15, arrayOfInt2, 0, paramArrayOfByte, 24);
        g(15, arrayOfInt2, 0, this.j, 4);
        g(15, arrayOfInt2, 0, arrayOfInt4, 0);
        paramArrayOfByte = this.h;
        paramArrayOfByte[18] = arrayOfInt4[2];
        paramArrayOfByte[19] = arrayOfInt4[3];
        g(15, arrayOfInt2, 0, paramArrayOfByte, 12);
        h(34, arrayOfInt2, 0, this.h, 4);
        n(17, arrayOfInt2, 0, this.i, 0);
      }
    }
    else
    {
      for (m = 0; m < 4; m++) {
        arrayOfInt2[m] ^= arrayOfInt1[(m + 4)];
      }
      e(arrayOfInt3, a, 8);
      paramArrayOfByte = this.i;
      if (paramBoolean)
      {
        ...
        paramArrayOfByte[2] = arrayOfInt1[2];
        paramArrayOfByte[3] = arrayOfInt1[3];
        o(45, arrayOfInt1, 0, this.h, 16);
        n(15, arrayOfInt1, 0, this.j, 4);
        n(17, arrayOfInt1, 0, this.h, 32);
        o(34, arrayOfInt1, 0, this.h, 44);
        n(15, arrayOfInt1, 4, this.h, 4);
        n(15, arrayOfInt1, 4, this.j, 0);
        n(30, arrayOfInt1, 4, this.h, 24);
        o(34, arrayOfInt1, 4, this.h, 36);
        n(15, arrayOfInt2, 0, this.h, 8);
        n(30, arrayOfInt2, 0, this.h, 20);
        paramArrayOfByte = this.j;
        paramArrayOfByte[8] = arrayOfInt2[1];
        paramArrayOfByte[9] = arrayOfInt2[2];
        paramArrayOfByte[10] = arrayOfInt2[3];
        paramArrayOfByte[11] = arrayOfInt2[0];
        o(49, arrayOfInt2, 0, this.h, 40);
        paramArrayOfByte = this.h;
        ...
        n(30, arrayOfInt3, 0, paramArrayOfByte, 12);
        n(30, arrayOfInt3, 0, this.h, 28);
        o(51, arrayOfInt3, 0, this.i, 4);
      }
      else
      {
        paramArrayOfByte[4] = arrayOfInt1[0];
        ...
        paramArrayOfByte[6] = arrayOfInt1[2];
        paramArrayOfByte[7] = arrayOfInt1[3];
        h(45, arrayOfInt1, 0, this.h, 28);
        g(15, arrayOfInt1, 0, this.j, 4);
        g(17, arrayOfInt1, 0, this.h, 12);
        h(34, arrayOfInt1, 0, this.h, 0);
        g(15, arrayOfInt1, 4, this.h, 40);
        g(15, arrayOfInt1, 4, this.j, 8);
        g(30, arrayOfInt1, 4, this.h, 20);
        h(34, arrayOfInt1, 4, this.h, 8);
        g(15, arrayOfInt2, 0, this.h, 36);
        g(30, arrayOfInt2, 0, this.h, 24);
        paramArrayOfByte = this.j;
        paramArrayOfByte[2] = arrayOfInt2[1];
        paramArrayOfByte[3] = arrayOfInt2[2];
        paramArrayOfByte[0] = arrayOfInt2[3];
        paramArrayOfByte[1] = arrayOfInt2[0];
        h(49, arrayOfInt2, 0, this.h, 4);
        paramArrayOfByte = this.h;
        ...
        g(30, arrayOfInt3, 0, paramArrayOfByte, 32);
        g(30, arrayOfInt3, 0, this.h, 16);
        o(51, arrayOfInt3, 0, this.i, 0);
      }
    }
  }
    ...
    throws DataLengthException, IllegalStateException
  {
    if (this.f)
    {
      if (paramInt1 + 16 <= paramArrayOfByte1.length)
      {
        ...
        {
          if (this.g) {
            return k(paramArrayOfByte1, paramInt1, paramArrayOfByte2, paramInt2);
          }
          return l(paramArrayOfByte1, paramInt1, paramArrayOfByte2, paramInt2);
        }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\org\bouncycastle\crypto\engines\b.class
