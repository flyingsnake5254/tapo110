  ...
  implements org.bouncycastle.jcajce.provider.util.b
{
  public PrivateKey a(h paramh)
    throws IOException
  {
    return new BCXMSSPrivateKey(paramh);
  }
  
  public PublicKey b(w paramw)
    throws IOException
  {
    return new BCXMSSPublicKey(paramw);
  }
    ...
    throws InvalidKeySpecException
  {
    ...
    {
      if (!(paramKey instanceof BCXMSSPublicKey)) {
        break label100;
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\org\bouncycastle\pqc\jcajce\provider\xmss\b.class
