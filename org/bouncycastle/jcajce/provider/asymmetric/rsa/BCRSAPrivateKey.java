  ...
  implements RSAPrivateKey, b
{
  ...
  BCRSAPrivateKey(i parami)
  {
    this.modulus = parami.j();
    this.privateExponent = parami.m();
  }
  
  BCRSAPrivateKey(d0 paramd0)
  {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\org\bouncycastle\jcajce\provider\asymmetric\rsa\BCRSAPrivateKey.class
