...
public class x1
  extends h.b
{
  public x1(d paramd, e parame1, e parame2)
  {
    this(paramd, parame1, parame2, false);
  }
  
  public x1(d paramd, e parame1, e parame2, boolean paramBoolean)
  {
  ...
  x1(d paramd, e parame1, e parame2, e[] paramArrayOfe, boolean paramBoolean)
  {
  ...
  public h J()
  {
    ...
    if (locale5.i()) {
      return new x1(locald, locale5, locald.p(), this.f);
    }
    e locale6 = locale5.o();
    e locale7;
    if (bool) {
    ...
    bool = this.f;
    return new x1(locald, locale6, locale5, new e[] { locale7 }, bool);
  }
  ...
  public h a(h paramh)
  {
    ...
    if (locale1.i())
    {
      ...
      if (paramh.i()) {
        return new x1(locald, paramh, locald.p(), this.f);
      }
    ...
    else
    {
      ...
      if (((e)localObject1).i()) {
        return new x1(locald, (e)localObject1, locald.p(), this.f);
      }
    ...
    bool2 = this.f;
    return new x1(locald, paramh, (e)localObject1, new e[] { localObject2 }, bool2);
  }
  ...
  public h z()
  {
    ...
    boolean bool = this.f;
    return new x1(locald, locale1, locale2, new e[] { locale3 }, bool);
  }
}


/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\e\a\b\a\a0\c\x1.class
