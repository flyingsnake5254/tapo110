...
public class j2
  extends h.b
{
  public j2(d paramd, e parame1, e parame2)
  {
    this(paramd, parame1, parame2, false);
  }
  
  public j2(d paramd, e parame1, e parame2, boolean paramBoolean)
  {
  ...
  j2(d paramd, e parame1, e parame2, e[] paramArrayOfe, boolean paramBoolean)
  {
  ...
  public h J()
  {
    ...
    if (locale2.i()) {
      return new j2(locald, locale2, locald.p().n(), this.f);
    }
    e locale6 = locale2.o();
    if (bool) {
      locale5 = locale2;
    ...
    if (bool) {
      ...
      locale3 = locale1.j(locale3);
    }
    e locale4 = locale3.p(locale2, locale4).a(locale6).a(locale5);
    bool = this.f;
    return new j2(locald, locale6, locale4, new e[] { locale5 }, bool);
  }
  ...
  public h K(h paramh)
  {
    ...
    if ((!locale2.i()) && (locale3.h()))
    {
      ...
      locale6 = locale3.j(locale1).a(locale7).l(locale5, locale6, locale1);
      locale7 = locale2.j(locale1);
      locale2 = locale7.a(locale5).o();
      if (locale2.i())
      {
        if (locale6.i()) {
          return paramh.J();
      ...
      if (locale6.i()) {
        return new j2(locald, locale6, locald.p().n(), this.f);
      }
      paramh = locale6.o().j(locale7);
      locale1 = locale6.j(locale2).j(locale1);
      locale3 = locale6.a(locale2).o().l(locale5, locale3.b(), locale1);
      boolean bool = this.f;
      return new j2(locald, paramh, locale3, new e[] { locale1 }, bool);
    }
    return J().a(paramh);
  }
  ...
  public h a(h paramh)
  {
    ...
    if (locale1.i())
    {
      ...
      localObject2 = ((h)localObject2).r();
      localObject1 = ((e)localObject2).a(locale4).d(paramh);
      localObject3 = ((e)localObject1).o().a((e)localObject1).a(paramh).b();
      if (((e)localObject3).i()) {
        return new j2(locald, (e)localObject3, locald.p().n(), this.f);
      }
      localObject2 = ((e)localObject1).j(paramh.a((e)localObject3)).a((e)localObject3).a((e)localObject2).d((e)localObject3).a((e)localObject3);
      paramh = locald.n(c.b);
    }
    else
    {
      ...
      if (((e)localObject1).i()) {
        return new j2(locald, (e)localObject1, locald.p().n(), this.f);
      }
    ...
    bool2 = this.f;
    return new j2(locald, (e)localObject3, (e)localObject2, new e[] { paramh }, bool2);
  }
  ...
  public h z()
  {
    ...
    boolean bool = this.f;
    return new j2(locald, locale1, locale2, new e[] { locale3 }, bool);
  }
}


/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\e\a\b\a\a0\c\j2.class
