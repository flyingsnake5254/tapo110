...
class ClassesInfoCache
{
  ...
  private CallbackInfo createInfo(Class<?> paramClass, @Nullable Method[] paramArrayOfMethod)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      localObject2 = getInfo(localObject1[j]).mHandlerToEvent.entrySet().iterator();
    ...
    while (i < k)
    {
      localObject2 = paramArrayOfMethod[i];
      ...
      if (localObject3 != null)
      {
        ...
        {
          verifyAndPutHandler(localHashMap, new MethodReference(j, (Method)localObject2), (Lifecycle.Event)localObject3, paramClass);
          bool = true;
        }
      }
      else
  ...
  boolean hasLifecycleMethods(Class<?> paramClass)
  {
    ...
    this.mHasLifecycleMethods.put(paramClass, Boolean.FALSE);
    return false;
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\lifecycle\ClassesInfoCache.class
