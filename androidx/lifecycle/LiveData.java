...
public abstract class LiveData<T>
{
  ...
  private abstract class ObserverWrapper
  {
    ...
    void activeStateChanged(boolean paramBoolean)
    {
      ...
      int i = localLiveData.mActiveCount;
      int j = 1;
      int k;
      if (i == 0) {
        k = 1;
      ...
      localLiveData.mActiveCount = (i + j);
      if ((k != 0) && (paramBoolean)) {
        localLiveData.onActive();
      }
      localLiveData = LiveData.this;
      if ((localLiveData.mActiveCount == 0) && (!this.mActive)) {
        localLiveData.onInactive();
      }
      if (this.mActive) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\lifecycle\LiveData.class
