  ...
  private ViewDragHelper(@NonNull Context paramContext, @NonNull ViewGroup paramViewGroup, @NonNull Callback paramCallback)
  {
    if (paramViewGroup != null)
    {
      if (paramCallback != null)
      {
        ...
        int i = (int)(paramContext.getResources().getDisplayMetrics().density * 20.0F + 0.5F);
            ...
            if ((this.mInitialMotionX != null) && (this.mInitialMotionY != null))
            {
              ...
              for (i = 0; i < k; i++)
              {
                ...
                if (isValidPointerForActionMove(m))
                {
                  ...
                  float f4 = f2 - this.mInitialMotionX[m];
                  f1 = f3 - this.mInitialMotionY[m];
                  View localView = findTopChildUnder((int)f2, (int)f3);
                  if ((localView != null) && (checkTouchSlop(localView, f4, f1))) {
                    j = 1;
                  } else {
                    j = 0;
                  }
                  if (j != 0)
                  {
                    ...
                    i1 = localView.getTop();
                    int i3 = (int)f1;
                    int i4 = this.mCallback.clampViewPositionVertical(localView, i1 + i3, i3);
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\customview\widget\ViewDragHelper.class
