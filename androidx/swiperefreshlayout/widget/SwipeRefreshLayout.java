  ...
  implements NestedScrollingParent, NestedScrollingChild
{
  ...
  private final Animation mAnimateToCorrectPosition = new Animation()
  {
    public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
    {
      ...
      if (!paramAnonymousTransformation.mUsingCustomStart) {
        i = paramAnonymousTransformation.mSpinnerOffsetEnd - Math.abs(paramAnonymousTransformation.mOriginalOffsetTop);
      } else {
        i = paramAnonymousTransformation.mSpinnerOffsetEnd;
      }
      paramAnonymousTransformation = SwipeRefreshLayout.this;
      int j = paramAnonymousTransformation.mFrom;
      int i = (int)((i - j) * paramAnonymousFloat);
      int k = paramAnonymousTransformation.mCircleView.getTop();
  ...
  private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener()
  {
    public void onAnimationEnd(Animation paramAnonymousAnimation)
    {
      ...
      {
        paramAnonymousAnimation.mProgress.setAlpha(255);
        SwipeRefreshLayout.this.mProgress.start();
        paramAnonymousAnimation = SwipeRefreshLayout.this;
        if (paramAnonymousAnimation.mNotify)
        {
          paramAnonymousAnimation = paramAnonymousAnimation.mListener;
    ...
    else
    {
      ...
      if (!this.mScale) {
        local5 = new Animation.AnimationListener()
        {
          ...
          {
            paramAnonymousAnimation = SwipeRefreshLayout.this;
            if (!paramAnonymousAnimation.mScale) {
  ...
  private void startScaleDownReturnToStartAnimation(int paramInt, Animation.AnimationListener paramAnimationListener)
  {
    ...
    Animation local8 = new Animation()
    {
      ...
      {
        paramAnonymousTransformation = SwipeRefreshLayout.this;
        float f = paramAnonymousTransformation.mStartingScale;
        paramAnonymousTransformation.setAnimationProgress(f + -f * paramAnonymousFloat);
        SwipeRefreshLayout.this.moveToStart(paramAnonymousFloat);
      }
    };
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    ((View)localObject).layout(paramInt2, paramInt3, paramInt1 - getPaddingLeft() - getPaddingRight() + paramInt2, paramInt4 - getPaddingTop() - getPaddingBottom() + paramInt3);
    ...
    ((ImageView)localObject).layout(paramInt1 - paramInt4, paramInt3, paramInt1 + paramInt4, paramInt2 + paramInt3);
  }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\swiperefreshlayout\widget\SwipeRefreshLayout.class
