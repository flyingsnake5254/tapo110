  ...
  private void setupAnimators()
  {
    ...
    localValueAnimator.addListener(new Animator.AnimatorListener()
    {
      ...
      public void onAnimationRepeat(Animator paramAnonymousAnimator)
      {
        ...
        if (localCircularProgressDrawable.mFinishing)
        {
          localCircularProgressDrawable.mFinishing = false;
        ...
        {
          localCircularProgressDrawable.mRotationCount += 1.0F;
        }
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\swiperefreshlayout\widget\CircularProgressDrawable.class
