...
public class ConstraintSet
{
  ...
  private void populateConstraint(Constraint paramConstraint, TypedArray paramTypedArray)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      case 23: 
        ...
        break;
      case 22: 
        k = paramTypedArray.getInt(k, paramConstraint.visibility);
        paramConstraint.visibility = k;
        paramConstraint.visibility = VISIBILITY_FLAGS[k];
        break;
      case 21: 
  ...
  void applyToInternal(ConstraintLayout paramConstraintLayout)
  {
    ...
    while (j < i)
    {
      ...
      if (k != -1)
      {
        if (this.mConstraints.containsKey(Integer.valueOf(k)))
        {
          ...
          int m = ((Constraint)localObject3).mHelperType;
          if ((m != -1) && (m == 1))
          {
            ...
            localObject5 = ((Constraint)localObject3).mReferenceIds;
            ...
            {
              localObject5 = ((Constraint)localObject3).mReferenceIdString;
              if (localObject5 != null)
              {
                localObject5 = convertReferenceString((View)localObject4, (String)localObject5);
                ((Constraint)localObject3).mReferenceIds = ((int[])localObject5);
                ((ConstraintHelper)localObject4).setReferencedIds((int[])localObject5);
              }
            }
          }
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((j != -1) && (j == 1))
      {
        ...
        {
          localObject5 = ((Constraint)localObject1).mReferenceIdString;
          if (localObject5 != null)
          {
            localObject5 = convertReferenceString((View)localObject4, (String)localObject5);
            ((Constraint)localObject1).mReferenceIds = ((int[])localObject5);
            ((ConstraintHelper)localObject4).setReferencedIds((int[])localObject5);
          }
        }
        ((Barrier)localObject4).setType(((Constraint)localObject1).mBarrierDirection);
        localObject5 = paramConstraintLayout.generateDefaultLayoutParams();
        ((ConstraintHelper)localObject4).validateParams();
        ((Constraint)localObject1).applyTo((ConstraintLayout.LayoutParams)localObject5);
        paramConstraintLayout.addView((View)localObject4, (ViewGroup.LayoutParams)localObject5);
      }
      if (((Constraint)localObject1).mIsGuideline)
      {
  ...
  public void clone(ConstraintLayout paramConstraintLayout)
  {
    ...
    while (j < i)
    {
      Object localObject = paramConstraintLayout.getChildAt(j);
      ...
      if (k != -1)
      {
        ...
        if ((localObject instanceof Barrier))
        {
          ...
          localConstraint.mReferenceIds = ((ConstraintHelper)localObject).getReferencedIds();
  ...
  public void removeFromHorizontalChain(int paramInt)
  {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt)))
    {
      ...
      if ((i == -1) && (j == -1))
      {
        k = localConstraint.startToEnd;
        j = localConstraint.endToStart;
        if ((k != -1) || (j != -1)) {
          if ((k != -1) && (j != -1))
          {
            connect(k, 7, j, 6, 0);
          ...
          {
            k = localConstraint.rightToRight;
            if (k != -1)
            {
              connect(i, 7, k, 7, 0);
            }
  ...
  public void removeFromVerticalChain(int paramInt)
  {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt)))
    {
      ...
      if ((i != -1) || (j != -1)) {
        ...
        {
          int k = localConstraint.bottomToBottom;
          if (k != -1)
          {
            connect(i, 4, k, 4, 0);
          }
  ...
  private static class Constraint
  {
    ...
    private void fillFrom(int paramInt, ConstraintLayout.LayoutParams paramLayoutParams)
    {
      ...
      boolean bool = paramLayoutParams.constrainedWidth;
    ...
    public Constraint clone()
    {
      ...
      if (arrayOfInt != null) {
        localConstraint.mReferenceIds = Arrays.copyOf(arrayOfInt, arrayOfInt.length);
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\constraintlayout\widget\ConstraintSet.class
