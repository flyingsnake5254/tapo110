  ...
  implements View.OnTouchListener
{
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if (!localAutoScrollHelper.mAnimating) {
        return;
      }
      if (localAutoScrollHelper.mNeedsReset)
      {
        localAutoScrollHelper.mNeedsReset = false;
        localAutoScrollHelper.mScroller.start();
      }
      ...
      {
        localAutoScrollHelper = AutoScrollHelper.this;
        if (localAutoScrollHelper.mNeedsCancel)
        {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\core\widget\AutoScrollHelper.class
