...
public final class TextViewCompat
{
  ...
  public static void setFirstBaselineToTopHeight(@NonNull TextView paramTextView, @IntRange(from=0L) @Px int paramInt)
  {
    ...
    if ((i >= 16) && (!paramTextView.getIncludeFontPadding())) {
  ...
  {
    int i = Build.VERSION.SDK_INT;
    if ((i >= 26) && (i <= 27) && (!(paramCallback instanceof OreoCallback))) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\core\widget\TextViewCompat.class
