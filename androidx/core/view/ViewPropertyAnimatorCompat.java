...
public final class ViewPropertyAnimatorCompat
{
    ...
    implements ViewPropertyAnimatorListener
  {
    ...
    public void onAnimationEnd(View paramView)
    {
      ...
      {
        Object localObject = this.mVpa;
        Runnable localRunnable = ((ViewPropertyAnimatorCompat)localObject).mEndAction;
        if (localRunnable != null)
        {
          ((ViewPropertyAnimatorCompat)localObject).mEndAction = null;
          localRunnable.run();
        }
    ...
    public void onAnimationStart(View paramView)
    {
      ...
      Object localObject = this.mVpa;
      Runnable localRunnable = ((ViewPropertyAnimatorCompat)localObject).mStartAction;
      if (localRunnable != null)
      {
        ((ViewPropertyAnimatorCompat)localObject).mStartAction = null;
        localRunnable.run();
      }
      localObject = paramView.getTag(2113929216);
      if ((localObject instanceof ViewPropertyAnimatorListener)) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\core\view\ViewPropertyAnimatorCompat.class
