  ...
  extends Service
{
  ...
  {
    ArrayList localArrayList1 = this.mCompatQueue;
    ...
    implements JobIntentService.CompatJobEngine
  {
      ...
      implements JobIntentService.GenericWorkItem
    {
      ...
      public void complete()
      {
        ...
        {
          JobParameters localJobParameters = JobIntentService.JobServiceEngineImpl.this.mParams;
          if (localJobParameters != null) {
            localJobParameters.completeWork(this.mJobWork);
          }
          return;
        }
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\core\app\JobIntentService.class
