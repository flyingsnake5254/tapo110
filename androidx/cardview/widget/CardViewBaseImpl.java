    ...
    RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper()
    {
      public void drawRoundRect(Canvas paramAnonymousCanvas, RectF paramAnonymousRectF, float paramAnonymousFloat, Paint paramAnonymousPaint)
      {
        ...
        if (paramAnonymousFloat >= 1.0F)
        {
          ...
          f2 = paramAnonymousRectF.left;
          f3 = paramAnonymousRectF.top;
          paramAnonymousCanvas.drawRect(f2 + f4 - 1.0F, f3, paramAnonymousRectF.right - f4 + 1.0F, f3 + f4, paramAnonymousPaint);
          f2 = paramAnonymousRectF.left;
          f3 = paramAnonymousRectF.bottom;
          paramAnonymousCanvas.drawRect(f2 + f4 - 1.0F, f3 - f4, paramAnonymousRectF.right - f4 + 1.0F, f3, paramAnonymousPaint);
        }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\cardview\widget\CardViewBaseImpl.class
