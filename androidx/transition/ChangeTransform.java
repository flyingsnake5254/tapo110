  ...
  extends Transition
{
  ...
  private void createGhostView(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2)
  {
    ...
    localGhostView.reserveEndViewTransition((ViewGroup)paramTransitionValues1.values.get("android:changeTransform:parent"), paramTransitionValues1.view);
    for (paramViewGroup = this;; paramViewGroup = (ViewGroup)localObject)
    {
      localObject = paramViewGroup.mParent;
      if (localObject == null) {
        break;
      }
    }
    ...
    if (SUPPORTS_VIEW_REMOVAL_SUPPRESSION)
    {
      ...
      if (paramViewGroup != paramTransitionValues2.view) {
  ...
  private ObjectAnimator createTransformAnimator(final TransitionValues paramTransitionValues1, final TransitionValues paramTransitionValues2, final boolean paramBoolean)
  {
    ...
    final Object localObject1 = (Matrix)paramTransitionValues2.values.get("android:changeTransform:matrix");
    ...
    localObject1 = (Transforms)paramTransitionValues2.values.get("android:changeTransform:transforms");
  ...
  private boolean parentsMatch(ViewGroup paramViewGroup1, ViewGroup paramViewGroup2)
  {
    ...
    if ((bool1) && (isValidTarget(paramViewGroup2)))
    {
      ...
      if (paramViewGroup2 == paramViewGroup1.view)
      {
        bool3 = bool2;
        break label68;
      }
    ...
    extends TransitionListenerAdapter
  {
    ...
    GhostListener(View paramView, GhostView paramGhostView)
    {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\transition\ChangeTransform.class
