...
class TooltipPopup
{
  ...
  private void computePosition(View paramView, int paramInt1, int paramInt2, boolean paramBoolean, WindowManager.LayoutParams paramLayoutParams)
  {
    ...
    Object localObject2 = this.mTmpDisplayFrame;
    ...
    localObject2 = this.mTmpAnchorPos;
    int j = localObject2[0];
    paramView = this.mTmpAppPos;
    localObject2[0] = (j - paramView[0]);
    localObject2[1] -= paramView[1];
    paramLayoutParams.x = (localObject2[0] + paramInt1 - ((View)localObject1).getWidth() / 2);
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\widget\TooltipPopup.class
