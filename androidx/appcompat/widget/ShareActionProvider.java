  ...
  extends ActionProvider
{
    ...
    implements ActivityChooserModel.OnChooseActivityListener
  {
    ...
    public boolean onChooseActivity(ActivityChooserModel paramActivityChooserModel, Intent paramIntent)
    {
      ...
      paramActivityChooserModel = localShareActionProvider.mOnShareTargetSelectedListener;
    ...
    implements MenuItem.OnMenuItemClickListener
  {
    ...
    public boolean onMenuItemClick(MenuItem paramMenuItem)
    {
      ...
      paramMenuItem = ActivityChooserModel.get(((ShareActionProvider)localObject).mContext, ((ShareActionProvider)localObject).mShareHistoryFileName).chooseActivity(paramMenuItem.getItemId());
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\widget\ShareActionProvider.class
