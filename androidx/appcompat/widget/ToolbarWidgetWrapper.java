  ...
  implements DecorToolbar
{
  ...
  public ToolbarWidgetWrapper(Toolbar paramToolbar, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    this.mToolbar.setNavigationOnClickListener(new View.OnClickListener()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        Window.Callback localCallback = paramAnonymousView.mWindowCallback;
        if ((localCallback != null) && (paramAnonymousView.mMenuPrepared)) {
          localCallback.onMenuItemSelected(0, this.mNavItem);
        }
      }
    });
  }
  ...
  public void setEmbeddedTabView(ScrollingTabContainerView paramScrollingTabContainerView)
  {
    ...
    if ((paramScrollingTabContainerView != null) && (this.mNavigationMode == 2))
    {
      ...
      ((ActionBar.LayoutParams)localObject).gravity = 8388691;
  ...
  public void setMenu(Menu paramMenu, MenuPresenter.Callback paramCallback)
  {
    ...
    {
      ActionMenuPresenter localActionMenuPresenter = new ActionMenuPresenter(this.mToolbar.getContext());
      this.mActionMenuPresenter = localActionMenuPresenter;
        ...
        if (i == 2)
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (localObject1 == localObject2) {
              ((ViewGroup)localObject2).removeView(this.mTabView);
            }
          }
        }
      }
      else
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject2 == localObject1) {
            ((ViewGroup)localObject1).removeView(this.mSpinner);
          }
        }
      }
        ...
        if (paramInt != 1)
        {
          if (paramInt == 2)
          {
            ...
            if (localObject1 != null)
            {
              ...
              ((ViewGroup.MarginLayoutParams)localObject1).width = -2;
              ((ViewGroup.MarginLayoutParams)localObject1).height = -2;
              ((ActionBar.LayoutParams)localObject1).gravity = 8388691;
            }
          }
          else
          {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\widget\ToolbarWidgetWrapper.class
