  ...
  extends ActionBar
{
    ...
    implements MenuPresenter.Callback
  {
    ...
    public void onCloseMenu(@NonNull MenuBuilder paramMenuBuilder, boolean paramBoolean)
    {
      ...
      Window.Callback localCallback = ToolbarActionBar.this.mWindowCallback;
    ...
    implements MenuBuilder.Callback
  {
    ...
    public void onMenuModeChange(@NonNull MenuBuilder paramMenuBuilder)
    {
      ...
      if (localToolbarActionBar.mWindowCallback != null) {
        if (localToolbarActionBar.mDecorToolbar.isOverflowMenuShowing()) {
    ...
    extends WindowCallbackWrapper
  {
    ...
    public boolean onPreparePanel(int paramInt, View paramView, Menu paramMenu)
    {
      ...
      if (bool)
      {
        ...
        if (!paramView.mToolbarMenuPrepared)
        {
          paramView.mDecorToolbar.setMenuPrepared();
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\app\ToolbarActionBar.class
