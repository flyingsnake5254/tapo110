...
class AlertController
{
  ...
  private final View.OnClickListener mButtonHandler = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      ...
      if (paramAnonymousView == localAlertController.mButtonPositive)
      {
        localMessage = localAlertController.mButtonPositiveMessage;
      ...
      if (paramAnonymousView == localAlertController.mButtonNegative)
      {
        localMessage = localAlertController.mButtonNegativeMessage;
        if (localMessage != null)
        {
          paramAnonymousView = Message.obtain(localMessage);
          break label82;
      ...
      if (paramAnonymousView == localAlertController.mButtonNeutral)
      {
        paramAnonymousView = localAlertController.mButtonNeutralMessage;
      ...
      paramAnonymousView.mHandler.obtainMessage(1, paramAnonymousView.mDialog).sendToTarget();
    }
  };
  ...
  {
    final Object localObject1 = this.mWindow.findViewById(R.id.scrollIndicatorUp);
  ...
  private void setupButtons(ViewGroup paramViewGroup)
  {
    ...
    else
    {
      ...
      localObject = this.mButtonNeutralIcon;
      if (localObject != null)
      {
        k = this.mButtonIconDimen;
        ((Drawable)localObject).setBounds(0, 0, k, k);
  ...
  private void setupView()
  {
    ...
    View localView1 = ((ViewGroup)localObject1).findViewById(i);
    View localView2 = ((ViewGroup)localObject1).findViewById(j);
    View localView3 = ((ViewGroup)localObject1).findViewById(k);
    ...
    j = ((ViewGroup)localObject1).getVisibility();
    k = 0;
    if (j != 8) {
      j = 1;
    } else {
    ...
    if ((localObject4 instanceof RecycleListView)) {
      ((RecycleListView)localObject4).setHasDecor(m, bool);
    }
    if (j == 0)
    {
      localObject4 = this.mListView;
      ...
      if (localObject4 != null)
      {
        ...
        setScrollIndicators((ViewGroup)localObject3, (View)localObject4, m | j, 3);
      }
    }
    localObject4 = this.mListView;
    if (localObject4 != null)
    {
      ...
      {
        ((ListView)localObject4).setAdapter((ListAdapter)localObject3);
        j = this.mCheckedItem;
        if (j > -1)
        {
          ((ListView)localObject4).setItemChecked(j, true);
          ((ListView)localObject4).setSelection(j);
        }
      }
    }
  }
  ...
  public static class AlertParams
  {
    ...
    private void createListView(final AlertController paramAlertController)
    {
        ...
        if (this.mCursor == null) {
          localObject = new ArrayAdapter(this.mContext, paramAlertController.mMultiChoiceItemLayout, 16908308, this.mItems)
          {
            public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
            {
              ...
              paramAnonymousViewGroup = AlertController.AlertParams.this.mCheckedItems;
      ...
      if (this.mOnClickListener != null) {
        ...
        localRecycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
          public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
          {
            paramAnonymousAdapterView = AlertController.AlertParams.this.mCheckedItems;
    ...
    public void apply(AlertController paramAlertController)
    {
      ...
      if ((localObject != null) || (this.mPositiveButtonIcon != null)) {
        paramAlertController.setButton(-1, (CharSequence)localObject, this.mPositiveButtonListener, null, this.mPositiveButtonIcon);
      }
      localObject = this.mNegativeButtonText;
      if ((localObject != null) || (this.mNegativeButtonIcon != null)) {
        paramAlertController.setButton(-2, (CharSequence)localObject, this.mNegativeButtonListener, null, this.mNegativeButtonIcon);
      }
      localObject = this.mNeutralButtonText;
      if ((localObject != null) || (this.mNeutralButtonIcon != null)) {
        paramAlertController.setButton(-3, (CharSequence)localObject, this.mNeutralButtonListener, null, this.mNeutralButtonIcon);
      }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\app\AlertController.class
