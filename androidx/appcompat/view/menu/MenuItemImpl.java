  ...
  implements SupportMenuItem
{
  ...
  char getShortcut()
  {
    ...
    {
      c1 = this.mShortcutAlphabeticChar;
      c2 = c1;
    }
    else
    {
      c1 = this.mShortcutNumericChar;
      c2 = c1;
    }
    return c2;
  }
    ...
    if (paramActionProvider != null) {
      paramActionProvider.setVisibilityListener(new ActionProvider.VisibilityListener()
      {
        public void onActionProviderVisibilityChanged(boolean paramAnonymousBoolean)
        {
          ...
          localMenuItemImpl.mMenu.onItemVisibleChanged(localMenuItemImpl);
        }
      });
    }
    return this;
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\view\menu\MenuItemImpl.class
