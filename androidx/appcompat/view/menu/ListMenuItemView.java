  ...
  implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    if ((this.mIconView != null) && (this.mPreserveIconSpacing))
    {
      ...
      if ((i > 0) && (localLayoutParams1.width <= 0)) {
  ...
  public void setIcon(Drawable paramDrawable)
  {
    ...
    if ((localImageView == null) && (paramDrawable == null) && (!this.mPreserveIconSpacing)) {
      return;
    }
    if (localImageView == null) {
      insertIconView();
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\view\menu\ListMenuItemView.class
