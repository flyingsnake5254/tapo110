  ...
  extends ContextWrapper
{
  ...
  private Resources getResourcesInternal()
  {
    ...
    {
      Object localObject = this.mOverrideConfiguration;
      if (localObject == null)
      {
      ...
      {
        this.mResources = createConfigurationContext((Configuration)localObject).getResources();
      }
      else
      {
        ...
        this.mResources = new Resources(((Resources)localObject).getAssets(), ((Resources)localObject).getDisplayMetrics(), localConfiguration);
      }
    }
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\appcompat\view\ContextThemeWrapper.class
