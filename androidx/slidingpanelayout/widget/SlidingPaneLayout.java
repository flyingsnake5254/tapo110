  ...
  extends ViewGroup
{
  ...
  private void dimChildView(View paramView, float paramFloat, int paramInt)
  {
    ...
    if ((paramFloat > 0.0F) && (paramInt != 0))
    {
      ...
      ((LayoutParams)localObject).dimPaint.setColorFilter(new PorterDuffColorFilter(i << 24 | paramInt & 0xFFFFFF, PorterDuff.Mode.SRC_OVER));
      if (paramView.getLayerType() != 2) {
        paramView.setLayerType(2, ((LayoutParams)localObject).dimPaint);
      }
      invalidateChildRegion(paramView);
    }
    else if (paramView.getLayerType() != 0)
    {
      localObject = ((LayoutParams)localObject).dimPaint;
      if (localObject != null) {
  ...
  void invalidateChildRegion(View paramView)
  {
    ...
    if (i >= 16)
    {
      if (!this.mDisplayListReflectionLoaded)
      {
        ...
        try
        {
          Field localField1 = View.class.getDeclaredField("mRecreateDisplayList");
          this.mRecreateDisplayList = localField1;
      ...
      {
        Field localField2 = this.mRecreateDisplayList;
        if (localField2 != null) {
          try
          {
            localField2.setBoolean(paramView, true);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (int m = 0; m < k; m++)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        localView.layout(paramInt3, j, i1, localView.getMeasuredHeight() + j);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (j = paramInt1; i3 < i2; j = paramInt1)
    {
      ...
      else
      {
        ...
        if (paramInt1 == -2) {
          paramInt1 = View.MeasureSpec.makeMeasureSpec(i1 - k, Integer.MIN_VALUE);
        } else if (paramInt1 == -1) {
        ...
        if (localView.getVisibility() != 8)
        {
          for (;;)
          {
            ...
            if (localView.getVisibility() != 8)
            {
              ...
              {
                if ((localLayoutParams.width < 0) && ((i3 > n) || (localLayoutParams.weight > 0.0F)))
                {
                  if (paramInt1 != 0)
                  {
  ...
  boolean smoothSlideTo(float paramFloat, int paramInt)
  {
    ...
    if (bool)
    {
      ...
      int j = ((ViewGroup.MarginLayoutParams)localObject).rightMargin;
      paramInt = this.mSlideableView.getWidth();
      paramInt = (int)(getWidth() - (i + j + paramFloat * this.mSlideRange + paramInt));
    }
    else
    {
      paramInt = (int)(getPaddingLeft() + ((ViewGroup.MarginLayoutParams)localObject).leftMargin + paramFloat * this.mSlideRange);
    }
    ...
    extends ViewDragHelper.Callback
  {
    ...
    public void onEdgeDragStarted(int paramInt1, int paramInt2)
    {
      ...
      localSlidingPaneLayout.mDragHelper.captureChildView(localSlidingPaneLayout.mSlideableView, paramInt2);
    }
    ...
    public void onViewDragStateChanged(int paramInt)
    {
      ...
      {
        SlidingPaneLayout localSlidingPaneLayout = SlidingPaneLayout.this;
        if (localSlidingPaneLayout.mSlideOffset == 0.0F)
        {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\slidingpanelayout\widget\SlidingPaneLayout.class
