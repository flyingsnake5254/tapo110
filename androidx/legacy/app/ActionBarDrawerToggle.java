  ...
  implements DrawerLayout.DrawerListener
{
  ...
  {
    Object localObject1 = this.mActivityImpl;
    if (localObject1 != null) {
      return ((Delegate)localObject1).getThemeUpIndicator();
    }
    if (Build.VERSION.SDK_INT >= 18)
    {
      localObject1 = this.mActivity.getActionBar();
      if (localObject1 != null) {
        localObject1 = ((ActionBar)localObject1).getThemedContext();
      } else {
        localObject1 = this.mActivity;
      }
      localObject2 = ((Context)localObject1).obtainStyledAttributes(null, THEME_ATTRS, 16843470, 0);
      localObject1 = ((TypedArray)localObject2).getDrawable(0);
      ((TypedArray)localObject2).recycle();
      return (Drawable)localObject1;
    }
    localObject1 = this.mActivity.obtainStyledAttributes(THEME_ATTRS);
  ...
  private void setActionBarUpIndicator(Drawable paramDrawable, int paramInt)
  {
    ...
    else
    {
      ...
      if (((SetIndicatorInfo)localObject).mSetHomeAsUpIndicator != null)
      {
        try
        {
          localObject = this.mActivity.getActionBar();
      ...
      {
        localObject = ((SetIndicatorInfo)localObject).mUpIndicatorView;
        if (localObject != null) {
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\legacy\app\ActionBarDrawerToggle.class
