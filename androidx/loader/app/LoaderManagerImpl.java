    ...
    implements Loader.OnLoadCompleteListener<D>
  {
    ...
    public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
    {
      ...
      if (this.mObserver != null)
      {
        ...
        paramArrayOfString = this.mObserver;
        paramFileDescriptor = new StringBuilder();
        paramFileDescriptor.append(paramString);
        paramFileDescriptor.append("  ");
        paramArrayOfString.dump(paramFileDescriptor.toString(), paramPrintWriter);
      }
      paramPrintWriter.print(paramString);
...
/* Location:              C:\Users\User\Desktop\decompile\jdgui110\Tapojar.jar!\androidx\loader\app\LoaderManagerImpl.class
